...
func (h *HUOBI) GetMarginRates(ctx context.Context, symbol currency.Pair) (MarginRatesData, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiMarginRates, vals, nil, &resp, false)
}
...
func (h *HUOBI) GetSpotKline(ctx context.Context, arg KlinesRequestParams) ([]KlineItem, error) {
	...
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketHistoryKline, vals), &result)
...
func (h *HUOBI) Get24HrMarketSummary(ctx context.Context, symbol currency.Pair) (MarketSummary24Hr, error) {
	...
	return result, h.SendHTTPRequest(ctx, goex.RestSpot, huobi24HrMarketSummary+params.Encode(), &result)
}

// GetTickers returns the ticker for the specified symbol
func (h *HUOBI) GetTickers(ctx context.Context) (Tickers, error) {
	var result Tickers
	return result, h.SendHTTPRequest(ctx, goex.RestSpot, huobiMarketTickers, &result)
}
...
func (h *HUOBI) GetMarketDetailMerged(ctx context.Context, symbol currency.Pair) (DetailMerged, error) {
	...
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketDetailMerged, vals), &result)
	if result.ErrorMessage != "" {
...
func (h *HUOBI) GetDepth(ctx context.Context, obd *OrderBookDataRequestParams) (*Orderbook, error) {
	...
	var result response
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketDepth, vals), &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetTrades(ctx context.Context, symbol currency.Pair) ([]Trade, error) {
	...
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketTrade, vals), &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetTradeHistory(ctx context.Context, symbol currency.Pair, size int64) ([]TradeHistory, error) {
	...
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketTradeHistory, vals), &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetMarketDetail(ctx context.Context, symbol currency.Pair) (Detail, error) {
	...
	err = h.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(huobiMarketDetail, vals), &result)
	if result.ErrorMessage != "" {
		return result.Tick, errors.New(result.ErrorMessage)
	}
	return result.Tick, err
...
func (h *HUOBI) GetSymbols(ctx context.Context) ([]Symbol, error) {
	...
	err := h.SendHTTPRequest(ctx, goex.RestSpot, huobiSymbols, &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetCurrencies(ctx context.Context) ([]string, error) {
	...
	err := h.SendHTTPRequest(ctx, goex.RestSpot, huobiCurrencies, &result)
	if result.ErrorMessage != "" {
		return nil, errors.New(result.ErrorMessage)
	}
...
func (h *HUOBI) GetCurrenciesIncludingChains(ctx context.Context, curr currency.Code) ([]CurrenciesChainData, error) {
	...
	err := h.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
	if err != nil {
		return nil, err
	}
...
func (h *HUOBI) GetCurrentServerTime(ctx context.Context) (time.Time, error) {
	...
	err := h.SendHTTPRequest(ctx, goex.RestSpot, "/v"+huobiAPIVersion+"/"+huobiTimestamp, &result)
	if result.ErrorMessage != "" {
...
func (h *HUOBI) GetAccounts(ctx context.Context) ([]Account, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiAccounts, url.Values{}, nil, &result, false)
...
func (h *HUOBI) GetAccountBalance(ctx context.Context, accountID string) ([]AccountBalanceDetail, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, endpoint, v, nil, &result, false)
...
func (h *HUOBI) GetAggregatedBalance(ctx context.Context) ([]AggregatedBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot,
		http.MethodGet,
...
func (h *HUOBI) CancelExistingOrder(ctx context.Context, orderID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) CancelOrderBatch(ctx context.Context, orderIDs, clientOrderIDs []string) (*CancelOrderBatch, error) {
	...
	return resp.Data, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, huobiOrderCancelBatch, nil, data, &resp, false)
}
...
func (h *HUOBI) CancelOpenOrdersBatch(ctx context.Context, accountID string, symbol currency.Pair) (CancelOpenOrdersBatch, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, huobiBatchCancelOpenOrders, url.Values{}, data, &result, false)
...
func (h *HUOBI) GetOrder(ctx context.Context, orderID int64) (OrderInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
		huobiGetOrder,
		urlVal,
		nil,
		&resp,
...
func (h *HUOBI) GetOrderMatchResults(ctx context.Context, orderID int64) ([]OrderMatchInfo, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, endpoint, url.Values{}, nil, &resp, false)
...
func (h *HUOBI) GetOrders(ctx context.Context, symbol currency.Pair, types, start, end, states, from, direct, size string) ([]OrderInfo, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiGetOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOpenOrders(ctx context.Context, symbol currency.Pair, accountID, side string, size int64) ([]OrderInfo, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiGetOpenOrders, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) GetOrdersMatch(ctx context.Context, symbol currency.Pair, types, start, end, from, direct, size string) ([]OrderMatchInfo, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiGetOrdersMatch, vals, nil, &resp, false)
	return resp.Orders, err
}
...
func (h *HUOBI) MarginTransfer(ctx context.Context, symbol currency.Pair, currency string, amount float64, in bool) (int64, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, path, nil, data, &resp, false)
...
func (h *HUOBI) MarginOrder(ctx context.Context, symbol currency.Pair, currency string, amount float64) (int64, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, huobiMarginOrders, nil, data, &resp, false)
...
func (h *HUOBI) MarginRepayment(ctx context.Context, orderID int64, amount float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, endpoint, nil, data, &resp, false)
	return resp.MarginOrderID, err
}
...
func (h *HUOBI) GetMarginLoanOrders(ctx context.Context, symbol currency.Pair, currency, start, end, states, from, direct, size string) ([]MarginOrder, error) {
	...
	err = h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiMarginLoanOrders, vals, nil, &resp, false)
...
func (h *HUOBI) GetMarginAccountBalance(ctx context.Context, symbol currency.Pair) ([]MarginAccountBalance, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiMarginAccountBalance, vals, nil, &resp, false)
	return resp.Balances, err
}
...
func (h *HUOBI) Withdraw(ctx context.Context, c currency.Code, address, addrTag, chain string, amount, fee float64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, huobiWithdrawCreate, nil, data, &resp, false)
...
func (h *HUOBI) CancelWithdraw(ctx context.Context, withdrawID int64) (int64, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, endpoint, vals, nil, &resp, false)
	return resp.WithdrawID, err
}
...
func (h *HUOBI) QueryDepositAddress(ctx context.Context, cryptocurrency currency.Code) ([]DepositAddress, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiAccountDepositAddress, vals, nil, &resp, true)
	if err != nil {
		return nil, err
	}
...
func (h *HUOBI) QueryWithdrawQuotas(ctx context.Context, cryptocurrency string) (WithdrawQuota, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiAccountWithdrawQuota, vals, nil, &resp, true)
	if err != nil {
...
func (h *HUOBI) SearchForExistedWithdrawsAndDeposits(ctx context.Context, c currency.Code, transferType, direction string, fromID, limit int64) (WithdrawalHistory, error) {
	...
	return resp, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, huobiWithdrawHistory, vals, nil, &resp, false)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (h *HUOBI) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (h *HUOBI) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, endpoint string, values url.Values, data, result interface{}, isVersion2API bool) error {
	var err error
...
func (h *HUOBI) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
	if feeBuilder.FeeType == goex.OfflineTradeFee || feeBuilder.FeeType == goex.CryptocurrencyTradeFee {

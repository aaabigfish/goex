...
import (
	...
	gctcrypto "github.com/aaabigfish/goex/common/crypto"
...
func (l *Lbank) GetTicker(ctx context.Context, symbol string) (TickerResponse, error) {
	...
	return t, l.SendHTTPRequest(ctx, goex.RestSpot, path, &t)
}
...
func (l *Lbank) GetTimestamp(ctx context.Context) (time.Time, error) {
	...
	err := l.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
	if err != nil {
...
func (l *Lbank) GetCurrencyPairs(ctx context.Context) ([]string, error) {
	path := fmt.Sprintf("/v%s/%s", lbankAPIVersion1,
		lbankCurrencyPairs)
	var result []string
	return result, l.SendHTTPRequest(ctx, goex.RestSpot, path, &result)
}
...
func (l *Lbank) GetMarketDepths(ctx context.Context, symbol, size, merge string) (*MarketDepthResponse, error) {
	...
	return &m, l.SendHTTPRequest(ctx, goex.RestSpot, path, &m)
}
...
func (l *Lbank) GetTrades(ctx context.Context, symbol string, limit, time int64) ([]TradeResponse, error) {
	...
	return g, l.SendHTTPRequest(ctx, goex.RestSpot, path, &g)
}
...
func (l *Lbank) GetKlines(ctx context.Context, symbol, size, klineType, tm string) ([]KlineResponse, error) {
	...
	err := l.SendHTTPRequest(ctx, goex.RestSpot, path, &klineTemp)
	if err != nil {
		return nil, err
	}
...
func (l *Lbank) GetPairInfo(ctx context.Context) ([]PairInfoResponse, error) {
	...
	return resp, l.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
}
...
func (l *Lbank) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {

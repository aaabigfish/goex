...
func (b *Bitfinex) GetPlatformStatus(ctx context.Context) (int, error) {
	var response []int
	err := b.SendHTTPRequest(ctx, goex.RestSpot,
		bitfinexAPIVersion2+
...
func (b *Bitfinex) GetV2MarginFunding(ctx context.Context, symbol, amount string, period int32) (MarginV2FundingData, error) {
	...
	err := b.SendAuthenticatedHTTPRequestV2(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitfinex) GetSiteListConfigData(ctx context.Context, set string) ([]string, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &resp, status)
	if err != nil {
		return nil, err
	}
	if len(resp) != 1 {
...
func (b *Bitfinex) GetSiteInfoConfigData(ctx context.Context, assetType asset.Item) ([]order.MinMaxLevel, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, url, &resp, status)
	if err != nil {
		return nil, err
	}
	if len(resp) != 1 {
...
func (b *Bitfinex) GetDerivativeStatusInfo(ctx context.Context, keys, startTime, endTime string, sort, limit int64) ([]DerivativeDataResponse, error) {
	...
	path := bitfinexAPIVersion2 + bitfinexDerivativeData +
		params.Encode()
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &result, status)
	if err != nil {
		return nil, err
	}
...
func (b *Bitfinex) GetTickerBatch(ctx context.Context) (map[string]Ticker, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, tickerBatch)
	if err != nil {
		return nil, err
	}
...
func (b *Bitfinex) GetTicker(ctx context.Context, symbol string) (*Ticker, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, tickerFunction)
	if err != nil {
		return nil, err
	}
...
func (b *Bitfinex) GetTrades(ctx context.Context, currencyPair string, limit, timestampStart, timestampEnd int64, reOrderResp bool) ([]Trade, error) {
	...
	var resp [][]interface{}
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &resp, tradeRateLimit)
	if err != nil {
		return nil, err
	}
...
func (b *Bitfinex) GetOrderbook(ctx context.Context, symbol, precision string, limit int64) (Orderbook, error) {
	...
	var response [][]interface{}
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, orderbookFunction)
	if err != nil {
...
func (b *Bitfinex) GetStats(ctx context.Context, symbol string) ([]Stat, error) {
	...
	return response, b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, statsV1)
}
...
func (b *Bitfinex) GetFundingBook(ctx context.Context, symbol string) (FundingBook, error) {
	...
	if err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, fundingbook); err != nil {
		return response, err
	}
...
func (b *Bitfinex) GetLends(ctx context.Context, symbol string, values url.Values) ([]Lends, error) {
	...
	path := common.EncodeURLValues(bitfinexAPIVersion+
		...
		symbol,
		values)
	return response, b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, lends)
}
...
func (b *Bitfinex) GetCandles(ctx context.Context, symbol, timeFrame string, start, end int64, limit uint32, historic bool) ([]Candle, error) {
	...
	if historic {
		...
		var response [][]interface{}
		err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response, candle)
		if err != nil {
			return nil, err
		}
...
func (b *Bitfinex) GetLeaderboard(ctx context.Context, key, timeframe, symbol string, sort, limit int, start, end string) ([]LeaderboardEntry, error) {
	...
	var resp []interface{}
	if err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &resp, leaderBoardReqRate); err != nil {
		return nil, err
	}
...
func (b *Bitfinex) GetAccountFees(ctx context.Context) ([]AccountInfo, error) {
	...
	return responses, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitfinexAccountInfo,
		nil,
		&responses,
		getAccountFees)
...
func (b *Bitfinex) GetWithdrawalFees(ctx context.Context) (AccountFees, error) {
	...
	return response, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitfinexAccountFees,
		nil,
		&response,
		getWithdrawalFees)
...
func (b *Bitfinex) WalletTransfer(ctx context.Context, amount float64, currency, walletFrom, walletTo string) (WalletTransfer, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitfinexTransfer,
		req,
		&response,
		walletTransfer)
...
func (b *Bitfinex) OrderUpdate(ctx context.Context, orderID, groupID, clientOrderID string, amount, price, leverage float64) (*Order, error) {
	...
	response := Order{}
	return &response, b.SendAuthenticatedHTTPRequestV2(ctx, goex.RestSpot, http.MethodPost,
		bitfinexOrderUpdate,
		req,
		&response,
		orderV1)
...
func (b *Bitfinex) CancelMultipleOrders(ctx context.Context, orderIDs []int64) (string, error) {
	...
	return response.Result, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitfinex) GetOrderStatus(ctx context.Context, orderID int64) (Order, error) {
	...
	return orderStatus, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitfinexOrderStatus,
		req,
		&orderStatus,
		orderMulti)
...
func (b *Bitfinex) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}, e request.EndpointLimit) error {
...
func (b *Bitfinex) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, path string, params map[string]interface{}, result interface{}, endpoint request.EndpointLimit) error {
...
// unmarshals result to a supplied variable
func (b *Bitfinex) SendAuthenticatedHTTPRequestV2(ctx context.Context, ep goex.URL, method, path string, params map[string]interface{}, result interface{}, endpoint request.EndpointLimit) error {
	creds, err := b.GetCredentials(ctx)
	if err != nil {
		return err
	}
...
func (b *Bitfinex) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

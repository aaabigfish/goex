...
func (k *Kraken) GetCurrentServerTime(ctx context.Context) (TimeResponse, error) {
	...
	if err := k.SendHTTPRequest(ctx, goex.RestSpot, path, &response); err != nil {
...
func (k *Kraken) GetAssetPairs(ctx context.Context, assetPairs []string, info string) (map[string]*AssetPairs, error) {
	...
	if err := k.SendHTTPRequest(ctx, goex.RestSpot, path+params.Encode(), &response); err != nil {
		return response.Result, err
	}
	return response.Result, GetError(response.Error)
}
...
func (k *Kraken) GetTicker(ctx context.Context, symbol currency.Pair) (Ticker, error) {
	...
	err = k.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
	if err != nil {
		return tick, err
	}
...
func (k *Kraken) GetOHLC(ctx context.Context, symbol currency.Pair, interval string) ([]OpenHighLowClose, error) {
	...
	err = k.SendHTTPRequest(ctx, goex.RestSpot, path, &result)
	if err != nil {
		return nil, err
	}
...
func (k *Kraken) GetTrades(ctx context.Context, symbol currency.Pair) ([]RecentTrades, error) {
	...
	err = k.SendHTTPRequest(ctx, goex.RestSpot, path, &data)
	if err != nil {
		return nil, err
	}
...
func (k *Kraken) GetBalance(ctx context.Context) (map[string]Balance, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenBalance, url.Values{}, &response); err != nil {
		return nil, err
	}
...
func (k *Kraken) GetWithdrawInfo(ctx context.Context, currency string, amount float64) (WithdrawInformation, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenWithdrawInfo, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) Withdraw(ctx context.Context, asset, key string, amount float64) (string, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenWithdraw, params, &response); err != nil {
...
func (k *Kraken) GetDepositMethods(ctx context.Context, currency string) ([]DepositMethods, error) {
	...
	err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenDepositMethods, params, &response)
	if err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetTradeBalance(ctx context.Context, args ...TradeBalanceOptions) (TradeBalanceInfo, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenTradeBalance, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetOpenOrders(ctx context.Context, args OrderInfoOptions) (OpenOrders, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenOpenOrders, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetClosedOrders(ctx context.Context, args GetClosedOrdersOptions) (ClosedOrders, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenClosedOrders, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) QueryOrdersInfo(ctx context.Context, args OrderInfoOptions, txid string, txids ...string) (map[string]OrderInfo, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenQueryOrders, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetTradesHistory(ctx context.Context, args ...GetTradesHistoryOptions) (TradesHistory, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenTradeHistory, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) QueryTrades(ctx context.Context, trades bool, txid string, txids ...string) (map[string]TradeInfo, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenQueryTrades, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) OpenPositions(ctx context.Context, docalcs bool, txids ...string) (map[string]Position, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenOpenPositions, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetLedgers(ctx context.Context, args ...GetLedgersOptions) (Ledgers, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenLedgers, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) QueryLedgers(ctx context.Context, id string, ids ...string) (map[string]LedgerInfo, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenQueryLedgers, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetTradeVolume(ctx context.Context, feeinfo bool, symbol ...currency.Pair) (*TradeVolumeResponse, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenTradeVolume, params, &response); err != nil {
		return nil, err
	}
...
func (k *Kraken) AddOrder(ctx context.Context, symbol currency.Pair, side, orderType string, volume, price, price2, leverage float64, args *AddOrderOptions) (AddOrderResponse, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenOrderPlace, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) CancelExistingOrder(ctx context.Context, txid string) (CancelOrderResponse, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenOrderCancel, values, &response); err != nil {
		return response.Result, err
	}
...
func GetError(apiErrors []string) error {
	...
	for _, e := range apiErrors {
		switch e[0] {
		case 'W':
			log.Warnf("ExchangeSys %s API warning: %v\n", exchangeName, e[1:])
		default:
...
func (k *Kraken) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (k *Kraken) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method string, params url.Values, result interface{}) error {
...
func (k *Kraken) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
	...
	case goex.InternationalBankDepositFee:
		...
		for _, i := range depositMethods {
			if feeBuilder.BankTransactionType == goex.WireTransfer {
	...
	case goex.CryptocurrencyDepositFee:
		fee = getCryptocurrencyDepositFee(feeBuilder.Pair.Base)

	case goex.InternationalBankWithdrawalFee:
...
func (k *Kraken) GetCryptoDepositAddress(ctx context.Context, method, code string, createNew bool) ([]DepositAddress, error) {
	...
	err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenDepositAddresses, values, &resp)
	if err != nil {
		return nil, err
	}
...
func (k *Kraken) WithdrawStatus(ctx context.Context, c currency.Code, method string) ([]WithdrawStatusResponse, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenWithdrawStatus, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) WithdrawCancel(ctx context.Context, c currency.Code, refID string) (bool, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenWithdrawCancel, params, &response); err != nil {
		return response.Result, err
	}
...
func (k *Kraken) GetWebsocketToken(ctx context.Context) (string, error) {
	...
	if err := k.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, krakenWebsocketToken, url.Values{}, &response); err != nil {
		return "", err
	}

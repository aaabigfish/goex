...
func (k *Kraken) GetFuturesOrderbook(ctx context.Context, symbol currency.Pair) (*FuturesOrderbookData, error) {
	...
	return &resp, k.SendHTTPRequest(ctx, goex.RestFutures, futuresOrderbook+"?"+params.Encode(), &resp)
}
...
func (k *Kraken) GetFuturesCharts(ctx context.Context, resolution, tickType string, symbol currency.Pair, to, from time.Time) (*FuturesCandles, error) {
	...
	return &resp, k.SendHTTPRequest(ctx, goex.RestFuturesSupplementary, reqStr, &resp)
}
...
func (k *Kraken) GetFuturesTrades(ctx context.Context, symbol currency.Pair, to, from time.Time) (*FuturesPublicTrades, error) {
	...
	return &resp, k.SendHTTPRequest(ctx, goex.RestFuturesSupplementary, futuresPublicTrades+"/"+symbolValue+"/executions?"+params.Encode(), &resp)
}
...
func (k *Kraken) GetInstruments(ctx context.Context) (FuturesInstrumentData, error) {
	...
	return resp, k.SendHTTPRequest(ctx, goex.RestFutures, futuresInstruments, &resp)
}
...
func (k *Kraken) GetFuturesTickers(ctx context.Context) (FuturesTickerData, error) {
	...
	return resp, k.SendHTTPRequest(ctx, goex.RestFutures, futuresTickers, &resp)
}
...
func (k *Kraken) GetFuturesTradeHistory(ctx context.Context, symbol currency.Pair, lastTime time.Time) (FuturesTradeHistoryData, error) {
	...
	return resp, k.SendHTTPRequest(ctx, goex.RestFutures, futuresTradeHistory+"?"+params.Encode(), &resp)
}
...
func (k *Kraken) SendFuturesAuthRequest(ctx context.Context, method, path string, data url.Values, result interface{}) error {
	...
	newRequest := func() (*request.Item, error) {
		...
		futuresURL, err = k.API.Endpoints.GetURL(goex.RestFutures)
		if err != nil {
			return nil, err
		}

...
func (p *Poloniex) GetTicker(ctx context.Context) (map[string]Ticker, error) {
	...
	return resp.Data, p.SendHTTPRequest(ctx, goex.RestSpot, path, &resp.Data)
}
...
func (p *Poloniex) GetVolume(ctx context.Context) (interface{}, error) {
	...
	return resp, p.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
}
...
func (p *Poloniex) GetOrderbook(ctx context.Context, currencyPair string, depth int) (OrderbookAll, error) {
	...
	if currencyPair != "" {
		...
		err := p.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
		if err != nil {
			return oba, err
		}
		if resp.Error != "" {
		...
		path := fmt.Sprintf("/public?command=returnOrderBook&%s", vals.Encode())
		err := p.SendHTTPRequest(ctx, goex.RestSpot, path, &resp.Data)
		if err != nil {
			return oba, err
		}
...
func (p *Poloniex) GetChartData(ctx context.Context, currencyPair string, start, end time.Time, period string) ([]ChartData, error) {
	...
	err := p.SendHTTPRequest(ctx, goex.RestSpot, path, &temp)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetBalances(ctx context.Context) (Balance, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexBalances, url.Values{}, &result)
	if err != nil {
		return Balance{}, err
	}
...
func (p *Poloniex) GetCompleteBalances(ctx context.Context) (CompleteBalances, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot,
		http.MethodPost,
...
func (p *Poloniex) GetDepositAddresses(ctx context.Context) (DepositAddresses, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexDepositAddresses, url.Values{}, &result)
	if err != nil {
...
func (p *Poloniex) GenerateNewAddress(ctx context.Context, curr string) (string, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexGenerateNewAddress, values, &resp)
	if err != nil {
		return "", err
	}
...
func (p *Poloniex) GetDepositsWithdrawals(ctx context.Context, start, end string) (DepositsWithdrawals, error) {
	...
	return resp, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexDepositsWithdrawals, values, &resp)
}
...
func (p *Poloniex) GetOpenOrders(ctx context.Context, currency string) (OpenOrdersResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexOrders, values, &result.Data)
}
...
func (p *Poloniex) GetAuthenticatedTradeHistoryForCurrency(ctx context.Context, currency string, start, end, limit int64) (AuthenticatedTradeHistoryResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexTradeHistory, values, &result.Data)
}
...
func (p *Poloniex) GetAuthenticatedTradeHistory(ctx context.Context, start, end, limit int64) (AuthenticatedTradeHistoryAll, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexTradeHistory, values, &result)
	if err != nil {
...
func (p *Poloniex) GetAuthenticatedOrderStatus(ctx context.Context, orderID string) (o OrderStatusData, err error) {
	...
	err = p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexOrderStatus, values, &rawOrderStatus)
	if err != nil {
		return o, err
	}
...
func (p *Poloniex) GetAuthenticatedOrderTrades(ctx context.Context, orderID string) (o []OrderTrade, err error) {
	...
	values.Set("orderNumber", orderID)
	var result json.RawMessage
	err = p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexOrderTrades, values, &result)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) PlaceOrder(ctx context.Context, currency string, rate, amount float64, immediate, fillOrKill, buy bool) (OrderResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, orderType, values, &result)
}
...
func (p *Poloniex) CancelExistingOrder(ctx context.Context, orderID int64) error {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexOrderCancel, values, &result)
	if err != nil {
		return err
	}
...
func (p *Poloniex) MoveOrder(ctx context.Context, orderID int64, rate, amount float64, postOnly, immediateOrCancel bool) (MoveOrderResponse, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		poloniexOrderMove,
		values,
		&result)
	if err != nil {
...
func (p *Poloniex) Withdraw(ctx context.Context, currency, address string, amount float64) (*Withdraw, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexWithdraw, values, &result)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetFeeInfo(ctx context.Context) (Fee, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexFeeInfo, url.Values{}, &result)
}
...
func (p *Poloniex) GetTradableBalances(ctx context.Context) (map[string]map[string]float64, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexTradableBalances, url.Values{}, &result.Data)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) TransferBalance(ctx context.Context, currency, from, to string, amount float64) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexTransferBalance, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) GetMarginAccountSummary(ctx context.Context) (Margin, error) {
	result := Margin{}
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexMarginAccountSummary, url.Values{}, &result)
}
...
func (p *Poloniex) GetMarginPosition(ctx context.Context, currency string) (interface{}, error) {
	...
	if currency != "" && currency != "all" {
		...
		return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexMarginPosition, values, &result)
	}
	values.Set("currencyPair", "all")
	...
	result := Response{}
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexMarginPosition, values, &result.Data)
}
...
func (p *Poloniex) CloseMarginPosition(ctx context.Context, currency string) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexMarginPositionClose, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) CreateLoanOffer(ctx context.Context, currency string, amount, rate float64, duration int, autoRenew bool) (int64, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexCreateLoanOffer, values, &result)
	if err != nil {
		return 0, err
	}
...
func (p *Poloniex) CancelLoanOffer(ctx context.Context, orderNumber int64) (bool, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexCancelLoanOffer, values, &result)
	if err != nil {
		return false, err
	}
...
func (p *Poloniex) GetOpenLoanOffers(ctx context.Context) (map[string][]LoanOffer, error) {
	...
	err := p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexOpenLoanOffers, url.Values{}, &result.Data)
	if err != nil {
		return nil, err
	}
...
func (p *Poloniex) GetActiveLoans(ctx context.Context) (ActiveLoans, error) {
	result := ActiveLoans{}
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, poloniexActiveLoans, url.Values{}, &result)
}
...
func (p *Poloniex) GetLendingHistory(ctx context.Context, start, end string) ([]LendingHistory, error) {
	...
	return resp, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (p *Poloniex) WalletActivity(ctx context.Context, start, end time.Time, activityType string) (*WalletActivityResponse, error) {
	...
	return &resp, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (p *Poloniex) CancelMultipleOrdersByIDs(ctx context.Context, orderIDs, clientOrderIDs []string) ([]CancelOrdersResponse, error) {
	...
	return result, p.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete,
		poloniexCancelByIDs,
		values,
		&result)
}
...
func (p *Poloniex) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (p *Poloniex) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, endpoint string, values url.Values, result interface{}) error {
...
func (p *Poloniex) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

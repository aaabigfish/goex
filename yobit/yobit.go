...
func (y *Yobit) GetInfo(ctx context.Context) (Info, error) {
	...
	return resp, y.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
}
...
func (y *Yobit) GetTicker(ctx context.Context, symbol string) (map[string]Ticker, error) {
	...
	return response.Data, y.SendHTTPRequest(ctx, goex.RestSpot, path, &response.Data)
}
...
func (y *Yobit) GetDepth(ctx context.Context, symbol string) (Orderbook, error) {
	...
	return response.Data[symbol],
		y.SendHTTPRequest(ctx, goex.RestSpot, path, &response.Data)
}
...
func (y *Yobit) GetTrades(ctx context.Context, symbol string) ([]Trade, error) {
	...
	err := y.SendHTTPRequest(ctx, goex.RestSpot, path, &dataHolder.Data)
	if err != nil {
		return nil, err
	}
...
func (y *Yobit) GetAccountInformation(ctx context.Context) (AccountInfo, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateAccountInfo, url.Values{}, &result)
	if err != nil {
		return result, err
	}
	if result.Error != "" {
...
func (y *Yobit) Trade(ctx context.Context, pair, orderType string, amount, price float64) (int64, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateTrade, req, &result)
	if err != nil {
...
func (y *Yobit) GetOpenOrders(ctx context.Context, pair string) (map[string]ActiveOrders, error) {
	...
	return result, y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateActiveOrders, req, &result)
}
...
func (y *Yobit) GetOrderInformation(ctx context.Context, orderID int64) (map[string]OrderInfo, error) {
	...
	return result, y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateOrderInfo, req, &result)
}
...
func (y *Yobit) CancelExistingOrder(ctx context.Context, orderID int64) error {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateCancelOrder, req, &result)
	if err != nil {
		return err
	}
	if result.Error != "" {
...
func (y *Yobit) GetTradeHistory(ctx context.Context, tidFrom, count, tidEnd, since, end int64, order, pair string) (map[string]TradeHistory, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateTradeHistory, req, &result)
	if err != nil {
		return nil, err
	}
	if result.Success == 0 {
...
func (y *Yobit) WithdrawCoinsToAddress(ctx context.Context, coin string, amount float64, address string) (WithdrawCoinsToAddress, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateWithdrawCoinsToAddress, req, &result)
	if err != nil {
		return result, err
	}
	if result.Error != "" {
...
func (y *Yobit) CreateCoupon(ctx context.Context, currency string, amount float64) (CreateCoupon, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateCreateCoupon, req, &result)
	if err != nil {
		return result, err
	}
	if result.Error != "" {
...
func (y *Yobit) RedeemCoupon(ctx context.Context, coupon string) (RedeemCoupon, error) {
	...
	err := y.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, privateRedeemCoupon, req, &result)
	if err != nil {
		return result, err
	}
	if result.Error != "" {
...
func (y *Yobit) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (y *Yobit) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, path string, params url.Values, result interface{}) (err error) {
...
func (y *Yobit) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func getInternationalBankDepositFee(c currency.Code, bankTransactionType goex.InternationalBankTransactionType) float64 {
	var fee float64
	switch bankTransactionType {
	case goex.PerfectMoney:
		if c.Equal(currency.USD) {

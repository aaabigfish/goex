...
func (y *Yobit) SetDefaults() {
	...
	err = y.API.Endpoints.SetDefaultEndpoints(map[goex.URL]string{
		goex.RestSpot:              apiPublicURL,
		goex.RestSpotSupplementary: apiPrivateURL,
	})
	if err != nil {
		log.Errorf("ExchangeSys err(%v)", err)
	}
...
// withdrawals
func (y *Yobit) GetAccountFundingHistory(_ context.Context) ([]goex.FundingHistory, error) {
	return nil, common.ErrFunctionNotSupported
}

// GetWithdrawalsHistory returns previous withdrawals data
func (y *Yobit) GetWithdrawalsHistory(_ context.Context, _ currency.Code, _ asset.Item) ([]goex.WithdrawalHistory, error) {
	return nil, common.ErrFunctionNotSupported
}
...
func (y *Yobit) GetFeeByType(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	if feeBuilder == nil {

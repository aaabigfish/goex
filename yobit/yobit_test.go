...
func TestGetFee(t *testing.T) {
	...
	feeBuilder.FeeType = goex.InternationalBankWithdrawalFee
	feeBuilder.FiatCurrency = currency.USD
	feeBuilder.BankTransactionType = goex.Qiwi
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
	...
	feeBuilder.FeeType = goex.InternationalBankWithdrawalFee
	feeBuilder.FiatCurrency = currency.USD
	feeBuilder.BankTransactionType = goex.WireTransfer
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
	...
	feeBuilder.FeeType = goex.InternationalBankWithdrawalFee
	feeBuilder.FiatCurrency = currency.USD
	feeBuilder.BankTransactionType = goex.Payeer
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
	...
	feeBuilder.BankTransactionType = goex.Capitalist
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
	...
	feeBuilder.FeeType = goex.InternationalBankWithdrawalFee
	feeBuilder.FiatCurrency = currency.USD
	feeBuilder.BankTransactionType = goex.AdvCash
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
	...
	feeBuilder.FeeType = goex.InternationalBankWithdrawalFee
	feeBuilder.FiatCurrency = currency.RUR
	feeBuilder.BankTransactionType = goex.PerfectMoney
	if _, err := y.GetFee(feeBuilder); err != nil {
		t.Error(err)
	}
}
...
func TestFormatWithdrawPermissions(t *testing.T) {
	t.Parallel()
	expectedResult := goex.AutoWithdrawCryptoWithAPIPermissionText + " & " + goex.WithdrawFiatViaWebsiteOnlyText

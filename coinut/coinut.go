...
func (c *COINUT) GetInstruments(ctx context.Context) (Instruments, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutInstruments, params, false, &result)
}
...
func (c *COINUT) GetInstrumentTicker(ctx context.Context, instrumentID int64) (Ticker, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutTicker, params, false, &result)
}
...
func (c *COINUT) GetInstrumentOrderbook(ctx context.Context, instrumentID, limit int64) (*Orderbook, error) {
	...
	return &result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrderbook, params, false, &result)
}
...
func (c *COINUT) GetTrades(ctx context.Context, instrumentID int64) (Trades, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutTrades, params, false, &result)
}
...
func (c *COINUT) GetUserBalance(ctx context.Context) (*UserBalance, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutBalance, nil, true, &result)
}
...
func (c *COINUT) NewOrder(ctx context.Context, instrumentID int64, quantity, price float64, buy bool, orderID uint32) (interface{}, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrder, params, true, &result)
}
...
func (c *COINUT) NewOrders(ctx context.Context, orders []Order) ([]OrdersBase, error) {
	...
	return result.Data, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrders, params, true, &result.Data)
}
...
func (c *COINUT) GetOpenOrders(ctx context.Context, instrumentID int64) (GetOpenOrdersResponse, error) {
	...
	params := make(map[string]interface{})
	params["inst_id"] = instrumentID
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrdersOpen, params, true, &result)
}
...
func (c *COINUT) CancelExistingOrder(ctx context.Context, instrumentID, orderID int64) (bool, error) {
	...
	err := c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrdersCancel, params, true, &result)
	if err != nil {
		return false, err
	}
	return true, nil
...
func (c *COINUT) CancelOrders(ctx context.Context, orders []CancelOrders) (CancelOrdersResponse, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOrdersCancel, params, true, &result)
}
...
func (c *COINUT) GetTradeHistory(ctx context.Context, instrumentID, start, limit int64) (TradeHistory, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutTradeHistory, params, true, &result)
}
...
func (c *COINUT) GetIndexTicker(ctx context.Context, asset string) (IndexTicker, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutIndexTicker, params, false, &result)
}
...
func (c *COINUT) GetOptionChain(ctx context.Context, asset, secType string) (OptionChainResponse, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutOptionChain, params, false, &result)
}
...
func (c *COINUT) GetPositionHistory(ctx context.Context, secType string, start, limit int) (PositionHistory, error) {
	...
	return result, c.SendHTTPRequest(ctx, goex.RestSpot, coinutPositionHistory, params, true, &result)
}
...
func (c *COINUT) GetOpenPositionsForInstrument(ctx context.Context, instrumentID int) ([]OpenPosition, error) {
	...
	return result.Positions,
		c.SendHTTPRequest(ctx, goex.RestSpot, coinutPositionOpen, params, true, &result)
}

// to-do: user position update via websocket

// SendHTTPRequest sends either an authenticated or unauthenticated HTTP request
func (c *COINUT) SendHTTPRequest(ctx context.Context, ep goex.URL, apiRequest string, params map[string]interface{}, authenticated bool, result interface{}) (err error) {
...
func (c *COINUT) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

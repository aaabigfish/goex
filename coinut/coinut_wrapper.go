...
func (c *COINUT) SetDefaults() {
	...
	c.Features = goex.Features{
		Supports: goex.FeaturesSupported{
			...
			WithdrawPermissions: goex.WithdrawCryptoViaWebsiteOnly |
	...
	err = c.API.Endpoints.SetDefaultEndpoints(map[goex.URL]string{
		goex.RestSpot:      coinutAPIURL,
		goex.WebsocketSpot: coinutWebsocketURL,
	})
	if err != nil {
		log.Errorf("ExchangeSys err(%v)", err)
	}
...
// withdrawals
func (c *COINUT) GetAccountFundingHistory(_ context.Context) ([]goex.FundingHistory, error) {
	return nil, common.ErrFunctionNotSupported
}

// GetWithdrawalsHistory returns previous withdrawals data
func (c *COINUT) GetWithdrawalsHistory(_ context.Context, _ currency.Code, _ asset.Item) ([]goex.WithdrawalHistory, error) {
	return nil, common.ErrFunctionNotSupported
}
...
func (c *COINUT) GetFeeByType(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	if feeBuilder == nil {

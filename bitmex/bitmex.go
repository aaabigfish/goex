...
func (b *Bitmex) GetAnnouncement(ctx context.Context) ([]Announcement, error) {
	...
	return announcement, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointAnnouncement,
		nil,
		&announcement)
}
...
func (b *Bitmex) GetUrgentAnnouncement(ctx context.Context) ([]Announcement, error) {
	...
	return announcement, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetAPIKeys(ctx context.Context) ([]APIKey, error) {
	...
	return keys, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) RemoveAPIKey(ctx context.Context, params APIKeyParams) (bool, error) {
	...
	return keyDeleted, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete,
		bitmexEndpointAPIkeys,
		&params,
		&keyDeleted)
}
...
func (b *Bitmex) DisableAPIKey(ctx context.Context, params APIKeyParams) (APIKey, error) {
	...
	return keyInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetTrollboxMessages(ctx context.Context, params ChatGetParams) ([]Chat, error) {
	...
	return messages, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointTrollbox, &params, &messages)
}
...
func (b *Bitmex) SendTrollboxMessage(ctx context.Context, params ChatSendParams) ([]Chat, error) {
	...
	return messages, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetTrollboxChannels(ctx context.Context) ([]ChatChannel, error) {
	...
	return channels, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointTrollboxChannels,
		nil,
		&channels)
}
...
func (b *Bitmex) GetTrollboxConnectedUsers(ctx context.Context) (ConnectedUsers, error) {
	...
	return users, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointTrollboxConnected, nil, &users)
}
...
func (b *Bitmex) GetAccountExecutions(ctx context.Context, params *GenericRequestParams) ([]Execution, error) {
	...
	return executionList, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetAccountExecutionTradeHistory(ctx context.Context, params *GenericRequestParams) ([]Execution, error) {
	...
	return tradeHistory, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetFullFundingHistory(ctx context.Context, symbol, count, filter, columns, start string, reverse bool, startTime, endTime time.Time) ([]Funding, error) {
	...
	return fundingHistory, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointFundingHistory+params.Encode(),
		nil,
		&fundingHistory)
}
...
func (b *Bitmex) GetInstruments(ctx context.Context, params *GenericRequestParams) ([]Instrument, error) {
	...
	return instruments, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointInstruments,
		params,
		&instruments)
}
...
func (b *Bitmex) GetActiveInstruments(ctx context.Context, params *GenericRequestParams) ([]Instrument, error) {
	...
	return activeInstruments, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointActiveInstruments,
		params,
		&activeInstruments)
}
...
func (b *Bitmex) GetActiveAndIndexInstruments(ctx context.Context) ([]Instrument, error) {
	...
	return activeAndIndices,
		b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointActiveAndIndexInstruments,
			nil,
			&activeAndIndices)
}
...
func (b *Bitmex) GetActiveIntervals(ctx context.Context) (InstrumentInterval, error) {
	...
	return interval, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointActiveIntervals,
		nil,
		&interval)
}
...
func (b *Bitmex) GetCompositeIndex(ctx context.Context, symbol, count, filter, columns, start, reverse string, startTime, endTime time.Time) ([]IndexComposite, error) {
	...
	return compositeIndices, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointCompositeIndex+"?"+params.Encode(),
		nil,
		&compositeIndices)
}
...
func (b *Bitmex) GetIndices(ctx context.Context) ([]Instrument, error) {
	...
	return indices, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointIndices, nil, &indices)
}
...
func (b *Bitmex) GetInsuranceFundHistory(ctx context.Context, params *GenericRequestParams) ([]Insurance, error) {
	...
	return history, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointIndices, params, &history)
}
...
func (b *Bitmex) GetLeaderboard(ctx context.Context, params LeaderboardGetParams) ([]Leaderboard, error) {
	...
	return leader, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointLeader, params, &leader)
}
...
func (b *Bitmex) GetAliasOnLeaderboard(ctx context.Context) (Alias, error) {
	...
	return alias, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointAlias, nil, &alias)
}
...
func (b *Bitmex) GetLiquidationOrders(ctx context.Context, params *GenericRequestParams) ([]Liquidation, error) {
	...
	return orders, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointLiquidation,
		params,
		&orders)
}
...
func (b *Bitmex) GetCurrentNotifications(ctx context.Context) ([]Notification, error) {
	...
	return notifications, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetOrders(ctx context.Context, params *OrdersRequest) ([]Order, error) {
	var orders []Order
	return orders, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
		bitmexEndpointOrder,
		params,
		&orders)
}
...
func (b *Bitmex) AmendOrder(ctx context.Context, params *OrderAmendParams) (Order, error) {
	...
	return order, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPut,
		bitmexEndpointOrder,
		params,
		&order)
}
...
func (b *Bitmex) CreateOrder(ctx context.Context, params *OrderNewParams) (Order, error) {
	...
	return orderInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitmexEndpointOrder,
		params,
		&orderInfo)
}
...
func (b *Bitmex) CancelOrders(ctx context.Context, params *OrderCancelParams) ([]Order, error) {
	...
	return cancelledOrders, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete,
		bitmexEndpointOrder,
		params,
		&cancelledOrders)
}
...
func (b *Bitmex) AmendBulkOrders(ctx context.Context, params OrderAmendBulkParams) ([]Order, error) {
	...
	return amendedOrders, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPut,
		bitmexEndpointBulk,
		params,
		&amendedOrders)
}
...
func (b *Bitmex) CreateBulkOrders(ctx context.Context, params OrderNewBulkParams) ([]Order, error) {
	...
	return orders, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitmexEndpointBulk,
		params,
		&orders)
}
...
func (b *Bitmex) CancelAllOrdersAfterTime(ctx context.Context, params OrderCancelAllAfterParams) ([]Order, error) {
	...
	return cancelledOrder, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) ClosePosition(ctx context.Context, params OrderClosePositionParams) ([]Order, error) {
	...
	return closedPositions, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		bitmexEndpointOrder,
		params,
		&closedPositions)
}
...
func (b *Bitmex) GetOrderbook(ctx context.Context, params OrderBookGetL2Params) ([]OrderBookL2, error) {
	...
	return orderBooks, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointOrderbookL2,
		params,
		&orderBooks)
}
...
func (b *Bitmex) GetPositions(ctx context.Context, params PositionGetParams) ([]Position, error) {
	...
	return positions, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) IsolatePosition(ctx context.Context, params PositionIsolateMarginParams) (Position, error) {
	...
	return position, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetQuotes(ctx context.Context, params *GenericRequestParams) ([]Quote, error) {
	...
	return quotations, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointQuote,
		params,
		&quotations)
}
...
func (b *Bitmex) GetQuotesByBuckets(ctx context.Context, params *QuoteGetBucketedParams) ([]Quote, error) {
	...
	return quotations, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointQuoteBucketed,
		params,
		&quotations)
}
...
func (b *Bitmex) GetSettlementHistory(ctx context.Context, params *GenericRequestParams) ([]Settlement, error) {
	...
	return history, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointSettlement,
		params,
		&history)
}
...
func (b *Bitmex) GetStats(ctx context.Context) ([]Stats, error) {
	...
	return stats, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointStats, nil, &stats)
}
...
func (b *Bitmex) GetStatsHistorical(ctx context.Context) ([]StatsHistory, error) {
	...
	return history, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointStatsHistory, nil, &history)
}
...
func (b *Bitmex) GetStatSummary(ctx context.Context) ([]StatsUSD, error) {
	...
	return summary, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointStatsSummary, nil, &summary)
}
...
func (b *Bitmex) GetTrade(ctx context.Context, params *GenericRequestParams) ([]Trade, error) {
	...
	return trade, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointTrade, params, &trade)
}
...
func (b *Bitmex) GetPreviousTrades(ctx context.Context, params *TradeGetBucketedParams) ([]Trade, error) {
	...
	return trade, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointTradeBucketed,
		params,
		&trade)
}
...
func (b *Bitmex) GetUserInfo(ctx context.Context) (User, error) {
	...
	return userInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
		bitmexEndpointUser,
		nil,
		&userInfo)
}
...
func (b *Bitmex) UpdateUserInfo(ctx context.Context, params *UserUpdateParams) (User, error) {
	...
	return userInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPut,
		bitmexEndpointUser,
		params,
		&userInfo)
}
...
func (b *Bitmex) GetAffiliateStatus(ctx context.Context) (AffiliateStatus, error) {
	...
	return status, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) CancelWithdraw(ctx context.Context, token string) (TransactionInfo, error) {
	...
	return info, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) CheckReferalCode(ctx context.Context, referralCode string) (float64, error) {
	...
	return percentage, b.SendHTTPRequest(ctx, goex.RestSpot, bitmexEndpointUserCheckReferralCode,
...
func (b *Bitmex) GetUserCommision(ctx context.Context) (UserCommission, error) {
	...
	return commissionInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) ConfirmEmail(ctx context.Context, token string) (ConfirmEmail, error) {
	...
	return confirmation, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) ConfirmTwoFactorAuth(ctx context.Context, token, typ string) (bool, error) {
	...
	return working, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetCryptoDepositAddress(ctx context.Context, cryptoCurrency string) (string, error) {
	...
	return address, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) DisableTFA(ctx context.Context, token, typ string) (bool, error) {
	...
	return disabled, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) UserLogOut(ctx context.Context) error {
	return b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) UserLogOutAll(ctx context.Context) (int64, error) {
	...
	return status, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetUserMargin(ctx context.Context, currency string) (UserMargin, error) {
	...
	return info, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetMinimumWithdrawalFee(ctx context.Context, currency string) (MinWithdrawalFee, error) {
	...
	return fee, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) GetUserPreferences(ctx context.Context, params UserPreferencesParams) (User, error) {
	...
	return userInfo, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) EnableTFA(ctx context.Context, typ string) (bool, error) {
	...
	return enabled, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
...
func (b *Bitmex) GetWalletInfo(ctx context.Context, currency string) (WalletInfo, error) {
	...
	if err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *Bitmex) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, params Parameter, result interface{}) error {
...
func (b *Bitmex) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, verb, path string, params Parameter, result interface{}) error {
...
func (b *Bitmex) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
	var err error

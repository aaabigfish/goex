...
func (b *Binance) GetUndocumentedInterestHistory(ctx context.Context) (MarginInfoData, error) {
	...
	if err := b.SendHTTPRequest(ctx, goex.EdgeCase1, undocumentedInterestHistory, spotDefaultRate, &resp); err != nil {
		return resp, err
	}
	return resp, nil
}
...
func (b *Binance) GetExchangeInfo(ctx context.Context) (ExchangeInfo, error) {
	...
	return resp, b.SendHTTPRequest(ctx,
		goex.RestSpotSupplementary, exchangeInfo, spotExchangeInfo, &resp)
}
...
func (b *Binance) GetMostRecentTrades(ctx context.Context, rtr RecentTradeRequestParams) ([]RecentTrade, error) {
	...
	return resp, b.SendHTTPRequest(ctx,
		goex.RestSpotSupplementary, path, spotDefaultRate, &resp)
}
...
func (b *Binance) GetHistoricalTrades(ctx context.Context, symbol string, limit int, fromID int64) ([]HistoricalTrade, error) {
	...
	return resp,
		b.SendAPIKeyHTTPRequest(ctx, goex.RestSpotSupplementary, path, spotDefaultRate, &resp)
}
...
func (b *Binance) GetUserMarginInterestHistory(ctx context.Context, assetCurrency currency.Code, isolatedSymbol currency.Pair, startTime, endTime time.Time, currentPage, size int64, archived bool) (*UserMarginInterestHistoryResponse, error) {
	...
	return &resp, b.SendAPIKeyHTTPRequest(ctx, goex.RestSpotSupplementary, path, spotDefaultRate, &resp)
}
...
func (b *Binance) GetPriceChangeStats(ctx context.Context, symbol currency.Pair) (PriceChangeStats, error) {
	...
	return resp, b.SendHTTPRequest(ctx,
		goex.RestSpotSupplementary, path, rateLimit, &resp)
}
...
func (b *Binance) GetTickers(ctx context.Context) ([]PriceChangeStats, error) {
	...
	return resp, b.SendHTTPRequest(ctx,
		goex.RestSpotSupplementary, priceChange, spotPriceChangeAllRate, &resp)
}
...
func (b *Binance) GetLatestSpotPrice(ctx context.Context, symbol currency.Pair) (SymbolPrice, error) {
	...
	return resp,
		b.SendHTTPRequest(ctx, goex.RestSpotSupplementary, path, rateLimit, &resp)
}
...
func (b *Binance) newOrder(ctx context.Context, api string, o *NewOrderRequest, resp *NewOrderResponse) error {
	...
	return b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, api, params, spotOrderRate, resp)
}
...
func (b *Binance) CancelExistingOrder(ctx context.Context, symbol currency.Pair, orderID int64, origClientOrderID string) (CancelOrderResponse, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodDelete, orderEndpoint, params, spotOrderRate, &resp)
}
...
func (bi *Binance) GetMyTrades(ctx context.Context, arg *GetTradesParams) ([]Trade, error) {
	var resp []Trade
	params := url.Values{}
	...
	return resp, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, myTrades, params, spotOrderQueryRate, &resp)
}
...
func (b *Binance) SendHTTPRequest(ctx context.Context, ePath goex.URL, path string, f request.EndpointLimit, result interface{}) error {
...
func (b *Binance) SendAPIKeyHTTPRequest(ctx context.Context, ePath goex.URL, path string, f request.EndpointLimit, result interface{}) error {
	endpointPath, err := b.API.Endpoints.GetURL(ePath)
	if err != nil {
		return err
	}
...
func (b *Binance) SendAuthHTTPRequest(ctx context.Context, ePath goex.URL, method, path string, params url.Values, f request.EndpointLimit, result interface{}) error {
	creds, err := b.GetCredentials(ctx)
	if err != nil {
		return err
	}
...
func (b *Binance) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func (b *Binance) GetDepositAddressForCurrency(ctx context.Context, currency, chain string) (*DepositAddress, error) {
	...
	return &d,
		b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, depositAddress, params, spotDefaultRate, &d)
}

// GetWsAuthStreamKey will retrieve a key to use for authorised WS streaming
func (b *Binance) GetWsAuthStreamKey(ctx context.Context) (string, error) {
	endpointPath, err := b.API.Endpoints.GetURL(goex.RestSpotSupplementary)
	if err != nil {
		return "", err
	}
...
func (b *Binance) CryptoLoanIncomeHistory(ctx context.Context, curr currency.Code, loanType string, startTime, endTime time.Time, limit int64) ([]CryptoLoansIncomeHistory, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanIncomeHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanBorrow(ctx context.Context, loanCoin currency.Code, loanAmount float64, collateralCoin currency.Code, collateralAmount float64, loanTerm int64) ([]CryptoLoanBorrow, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, loanBorrow, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanBorrowHistory(ctx context.Context, orderID int64, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*LoanBorrowHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanBorrowHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanOngoingOrders(ctx context.Context, orderID int64, loanCoin, collateralCoin currency.Code, current, limit int64) (*CryptoLoanOngoingOrder, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanOngoingOrders, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanRepay(ctx context.Context, orderID int64, amount float64, repayType int64, collateralReturn bool) ([]CryptoLoanRepay, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, loanRepay, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanRepaymentHistory(ctx context.Context, orderID int64, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*CryptoLoanRepayHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanRepaymentHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanAdjustLTV(ctx context.Context, orderID int64, reduce bool, amount float64) (*CryptoLoanAdjustLTV, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, loanAdjustLTV, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanLTVAdjustmentHistory(ctx context.Context, orderID int64, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*CryptoLoanLTVAdjustmentHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanLTVAdjustmentHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanAssetsData(ctx context.Context, loanCoin currency.Code, vipLevel int64) (*LoanableAssetsData, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanableAssetsData, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanCollateralAssetsData(ctx context.Context, collateralCoin currency.Code, vipLevel int64) (*CollateralAssetData, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanCollateralAssetsData, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanCheckCollateralRepayRate(ctx context.Context, loanCoin, collateralCoin currency.Code, amount float64) (*CollateralRepayRate, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, loanCheckCollateralRepayRate, params, spotDefaultRate, &resp)
}
...
func (b *Binance) CryptoLoanCustomiseMarginCall(ctx context.Context, orderID int64, collateralCoin currency.Code, marginCallValue float64) (*CustomiseMarginCall, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, loanCustomiseMarginCall, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanBorrow(ctx context.Context, loanCoin, collateralCoin currency.Code, loanAmount, collateralAmount float64) (*FlexibleLoanBorrow, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, flexibleLoanBorrow, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanOngoingOrders(ctx context.Context, loanCoin, collateralCoin currency.Code, current, limit int64) (*FlexibleLoanOngoingOrder, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanOngoingOrders, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanBorrowHistory(ctx context.Context, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*FlexibleLoanBorrowHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanBorrowHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanRepay(ctx context.Context, loanCoin, collateralCoin currency.Code, amount float64, collateralReturn, fullRepayment bool) (*FlexibleLoanRepay, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, flexibleLoanRepay, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanRepayHistory(ctx context.Context, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*FlexibleLoanRepayHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanRepayHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanAdjustLTV(ctx context.Context, loanCoin, collateralCoin currency.Code, amount float64, reduce bool) (*FlexibleLoanAdjustLTV, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, flexibleLoanAdjustLTV, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanLTVAdjustmentHistory(ctx context.Context, loanCoin, collateralCoin currency.Code, startTime, endTime time.Time, current, limit int64) (*FlexibleLoanLTVAdjustmentHistory, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanLTVHistory, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleLoanAssetsData(ctx context.Context, loanCoin currency.Code) (*FlexibleLoanAssetsData, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanAssetsData, params, spotDefaultRate, &resp)
}
...
func (b *Binance) FlexibleCollateralAssetsData(ctx context.Context, collateralCoin currency.Code) (*FlexibleCollateralAssetsData, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, flexibleLoanCollateralAssetsData, params, spotDefaultRate, &resp)
}

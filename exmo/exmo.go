...
func (e *EXMO) GetTrades(ctx context.Context, symbol string) (map[string][]Trades, error) {
	...
	return result, e.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues(urlPath, v), &result)
}
...
func (e *EXMO) GetPairSettings(ctx context.Context) (map[string]PairSettings, error) {
	...
	return result, e.SendHTTPRequest(ctx, goex.RestSpot, urlPath, &result)
}
...
func (e *EXMO) GetUserInfo(ctx context.Context) (UserInfo, error) {
	var result UserInfo
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoUserInfo, url.Values{}, &result)
}
...
func (e *EXMO) CreateOrder(ctx context.Context, pair, orderType string, price, amount float64) (int64, error) {
	...
	var resp response
	return resp.OrderID, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoOrderCreate, v, &resp)
}
...
func (e *EXMO) CancelExistingOrder(ctx context.Context, orderID int64) error {
	...
	var resp response
	return e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoOrderCancel, v, &resp)
}
...
func (e *EXMO) GetOpenOrders(ctx context.Context) (map[string]OpenOrders, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoOpenOrders, url.Values{}, &result)
}
...
func (e *EXMO) GetUserTrades(ctx context.Context, pair, offset, limit string) (map[string][]UserTrades, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoUserTrades, v, &result)
}
...
func (e *EXMO) GetCancelledOrders(ctx context.Context, offset, limit string) ([]CancelledOrder, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoCancelledOrders, v, &result)
}
...
func (e *EXMO) GetOrderTrades(ctx context.Context, orderID int64) (OrderTrades, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoOrderTrades, v, &result)
}
...
func (e *EXMO) GetRequiredAmount(ctx context.Context, pair string, amount float64) (RequiredAmount, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoRequiredAmount, v, &result)
}
...
func (e *EXMO) GetCryptoDepositAddress(ctx context.Context) (map[string]string, error) {
	...
	err := e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoDepositAddress, url.Values{}, &result)
	if err != nil {
		return nil, err
	}
...
func (e *EXMO) WithdrawCryptocurrency(ctx context.Context, currency, address, invoice, transport string, amount float64) (int64, error) {
	...
	var resp response
	return resp.TaskID, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoWithdrawCrypt, v, &resp)
}
...
func (e *EXMO) GetWithdrawTXID(ctx context.Context, taskID int64) (string, error) {
	...
	var result response
	return result.TXID, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoGetWithdrawTXID, v, &result)
}
...
func (e *EXMO) ExcodeCreate(ctx context.Context, currency string, amount float64) (ExcodeCreate, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoExcodeCreate, v, &result)
}
...
func (e *EXMO) ExcodeLoad(ctx context.Context, excode string) (ExcodeLoad, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoExcodeLoad, v, &result)
}
...
func (e *EXMO) GetWalletHistory(ctx context.Context, date int64) (WalletHistory, error) {
	...
	return result, e.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, exmoWalletHistory, v, &result)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (e *EXMO) SendHTTPRequest(ctx context.Context, endpoint goex.URL, path string, result interface{}) error {
...
func (e *EXMO) SendAuthenticatedHTTPRequest(ctx context.Context, epath goex.URL, method, endpoint string, vals url.Values, result interface{}) error {
...
func (e *EXMO) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func getInternationalBankWithdrawalFee(c currency.Code, amount float64, bankTransactionType goex.InternationalBankTransactionType) float64 {
	var fee float64

	switch bankTransactionType {
	case goex.WireTransfer:
		switch c {
		case currency.RUB:
			fee = 3200
		case currency.PLN:
...
func getInternationalBankDepositFee(c currency.Code, amount float64, bankTransactionType goex.InternationalBankTransactionType) float64 {
	var fee float64
	switch bankTransactionType {
	case goex.WireTransfer:
		switch c {
...
func (e *EXMO) GetCryptoPaymentProvidersList(ctx context.Context) (map[string][]CryptoPaymentProvider, error) {
	...
	return result, e.SendHTTPRequest(ctx, goex.RestSpot, path, &result)
}

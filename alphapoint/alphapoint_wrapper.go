...
func (a *Alphapoint) SetDefaults() {
	...
	err := a.API.Endpoints.SetDefaultEndpoints(map[goex.URL]string{
		goex.RestSpot:      alphapointDefaultAPIURL,
		goex.WebsocketSpot: alphapointDefaultWebsocketURL,
	})
	if err != nil {
	...
	a.Features = goex.Features{
		Supports: goex.FeaturesSupported{
			...
			WithdrawPermissions: goex.WithdrawCryptoWith2FA |
				goex.AutoWithdrawCryptoWithAPIPermission |
...
// withdrawals
func (a *Alphapoint) GetAccountFundingHistory(_ context.Context) ([]goex.FundingHistory, error) {
	// https://alphapoint.github.io/slate/#generatetreasuryactivityreport
	return nil, common.ErrNotYetImplemented
}

// GetWithdrawalsHistory returns previous withdrawals data
func (a *Alphapoint) GetWithdrawalsHistory(_ context.Context, _ currency.Code, _ asset.Item) ([]goex.WithdrawalHistory, error) {
	return nil, common.ErrNotYetImplemented
}
...
func (a *Alphapoint) GetFeeByType(_ context.Context, _ *goex.FeeBuilder) (float64, error) {

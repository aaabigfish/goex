...
func (b *Bitflyer) GetLatestBlockCA(ctx context.Context) (ChainAnalysisBlock, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.ChainAnalysis, latestBlock, &resp)
}
...
func (b *Bitflyer) GetBlockCA(ctx context.Context, blockhash string) (ChainAnalysisBlock, error) {
	var resp ChainAnalysisBlock
	return resp, b.SendHTTPRequest(ctx, goex.ChainAnalysis, blockByBlockHash+blockhash, &resp)
}
...
func (b *Bitflyer) GetBlockbyHeightCA(ctx context.Context, height int64) (ChainAnalysisBlock, error) {
	var resp ChainAnalysisBlock
	return resp, b.SendHTTPRequest(ctx, goex.ChainAnalysis, blockByBlockHeight+strconv.FormatInt(height, 10), &resp)
}
...
func (b *Bitflyer) GetTransactionByHashCA(ctx context.Context, txHash string) (ChainAnalysisTransaction, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.ChainAnalysis, transaction+txHash, &resp)
}
...
func (b *Bitflyer) GetAddressInfoCA(ctx context.Context, addressln string) (ChainAnalysisAddress, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.ChainAnalysis, address+addressln, &resp)
}

// GetMarkets returns market information
func (b *Bitflyer) GetMarkets(ctx context.Context) ([]MarketInfo, error) {
	var resp []MarketInfo
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, pubGetMarkets, &resp)
}
...
func (b *Bitflyer) GetOrderBook(ctx context.Context, symbol string) (Orderbook, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, pubGetBoard+"?"+v.Encode(), &resp)
}
...
func (b *Bitflyer) GetTicker(ctx context.Context, symbol string) (Ticker, error) {
	...
	v := url.Values{}
	v.Set("product_code", symbol)
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, pubGetTicker+"?"+v.Encode(), &resp)
}
...
func (b *Bitflyer) GetExecutionHistory(ctx context.Context, symbol string) ([]ExecutedTrade, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, pubGetExecutionHistory+"?"+v.Encode(), &resp)
}
...
func (b *Bitflyer) GetExchangeStatus(ctx context.Context) (string, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, pubGetHealth, &resp)
	if err != nil {
		return "", err
	}
...
func (b *Bitflyer) GetChats(ctx context.Context, fromDate string) ([]ChatLog, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, pubGetChats+"?"+v.Encode(), &resp)
}
...
func (b *Bitflyer) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (b *Bitflyer) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func getDepositFee(bankTransactionType goex.InternationalBankTransactionType, c currency.Code) (fee float64) {
	if bankTransactionType == goex.WireTransfer {
...
func getWithdrawalFee(bankTransactionType goex.InternationalBankTransactionType, c currency.Code, amount float64) (fee float64) {
	if bankTransactionType == goex.WireTransfer {
		if c.Item == currency.JPY.Item {
			if amount < 30000 {
				fee = 540

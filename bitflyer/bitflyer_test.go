...
func TestGetAddressInfoCA(t *testing.T) {
	t.Parallel()
	v, err := b.GetAddressInfoCA(context.Background(), common.BitcoinDonationAddress)
	if err != nil {
...
func TestFormatWithdrawPermissions(t *testing.T) {
	t.Parallel()
	expectedResult := goex.AutoWithdrawFiatText + " & " + goex.WithdrawCryptoViaWebsiteOnlyText

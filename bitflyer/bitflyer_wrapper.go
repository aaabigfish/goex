...
func (b *Bitflyer) SetDefaults() {
	...
	err = b.API.Endpoints.SetDefaultEndpoints(map[goex.URL]string{
		goex.RestSpot:      japanURL,
		goex.ChainAnalysis: chainAnalysis,
	})
	if err != nil {
		log.Errorf("ExchangeSys err(%v)", err)
	}
...
// withdrawals
func (b *Bitflyer) GetAccountFundingHistory(_ context.Context) ([]goex.FundingHistory, error) {
	return nil, common.ErrFunctionNotSupported
}

// GetWithdrawalsHistory returns previous withdrawals data
func (b *Bitflyer) GetWithdrawalsHistory(_ context.Context, _ currency.Code, _ asset.Item) ([]goex.WithdrawalHistory, error) {
...
func (b *Bitflyer) GetFeeByType(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	if feeBuilder == nil {

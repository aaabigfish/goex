...
func (b *BTSE) FetchFundingHistory(ctx context.Context, symbol string) (map[string][]FundingHistoryData, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestFutures, http.MethodGet, btseFuturesFunding+params.Encode(), &resp, false, queryFunc)
}
...
func (b *BTSE) GetMarketSummary(ctx context.Context, symbol string, spot bool) (MarketSummary, error) {
	...
	return m, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, &m, spot, queryFunc)
}
...
func (b *BTSE) FetchOrderBook(ctx context.Context, symbol string, group, limitBids, limitAsks int, spot bool) (*Orderbook, error) {
	...
	return &o, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *BTSE) FetchOrderBookL2(ctx context.Context, symbol string, depth int) (*Orderbook, error) {
	...
	return &o, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet, endpoint, &o, true, queryFunc)
}
...
func (b *BTSE) GetTrades(ctx context.Context, symbol string, start, end time.Time, beforeSerialID, afterSerialID, count int, includeOld, spot bool) ([]Trade, error) {
	...
	return t, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (b *BTSE) GetOHLCV(ctx context.Context, symbol string, start, end time.Time, resolution int, a asset.Item) (OHLCV, error) {
	...
	return o, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet, endpoint, &o, a == asset.Spot, queryFunc)
}
...
func (b *BTSE) GetPrice(ctx context.Context, symbol string) (Price, error) {
	...
	return p, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, &p, true, queryFunc)
}
...
func (b *BTSE) GetCurrentServerTime(ctx context.Context) (*ServerTime, error) {
	var s ServerTime
	return &s, b.SendHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseTime, &s, true, queryFunc)
}
...
func (b *BTSE) GetWalletInformation(ctx context.Context) ([]CurrencyBalance, error) {
	...
	return a, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseWallet, true, nil, nil, &a, queryFunc)
}
...
func (b *BTSE) GetFeeInformation(ctx context.Context, symbol string) ([]AccountFees, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseUserFee, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) GetWalletHistory(ctx context.Context, symbol string, start, end time.Time, count int) (WalletHistory, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseWalletHistory, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) GetWalletAddress(ctx context.Context, currency string) (WalletAddress, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseWalletAddress, true, urlValues, nil, &resp, queryFunc)
}
...
func (b *BTSE) CreateWalletAddress(ctx context.Context, currency string) (WalletAddress, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, btseWalletAddress, true, nil, req, &resp, queryFunc)
	if err != nil {
...
func (b *BTSE) WalletWithdrawal(ctx context.Context, currency, address, tag, amount string) (WithdrawalResponse, error) {
	...
	req["tag"] = tag
	req["amount"] = amount
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, btseWalletWithdrawal, true, nil, req, &resp, queryFunc)
}
...
func (b *BTSE) CreateOrder(ctx context.Context, clOrderID string, deviation float64, postOnly bool, price float64, side string, size, stealth, stopPrice float64, symbol, timeInForce string, trailValue, triggerPrice float64, txType, orderType string) ([]Order, error) {
	...
	var r []Order
	return r, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, btseOrder, true, url.Values{}, req, &r, orderFunc)
}
...
func (b *BTSE) GetOrders(ctx context.Context, symbol, orderID, clOrderID string) ([]OpenOrder, error) {
	...
	var o []OpenOrder
	return o, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btsePendingOrders, true, req, nil, &o, orderFunc)
}
...
func (b *BTSE) CancelExistingOrder(ctx context.Context, orderID, symbol, clOrderID string) (CancelOrder, error) {
	...
	return c, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, btseOrder, true, req, nil, &c, orderFunc)
}
...
func (b *BTSE) CancelAllAfter(ctx context.Context, timeout int) error {
	req := make(map[string]interface{})
	req["timeout"] = timeout
	return b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, btseCancelAllAfter, true, url.Values{}, req, nil, orderFunc)
}
...
func (b *BTSE) IndexOrderPeg(ctx context.Context, clOrderID string, deviation float64, postOnly bool, price float64, side string, size, stealth, stopPrice float64, symbol, timeInForce string, trailValue, triggerPrice float64, txType, orderType string) ([]Order, error) {
	...
	return o, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, btsePegOrder, true, url.Values{}, req, nil, orderFunc)
}
...
func (b *BTSE) TradeHistory(ctx context.Context, symbol string, start, end time.Time, beforeSerialID, afterSerialID, count int, includeOld bool, clOrderID, orderID string) (TradeHistory, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, btseExchangeHistory, true, urlValues, nil, &resp, queryFunc)
}

// SendHTTPRequest sends an HTTP request to the desired endpoint
func (b *BTSE) SendHTTPRequest(ctx context.Context, ep goex.URL, method, endpoint string, result interface{}, spotEndpoint bool, f request.EndpointLimit) error {
...
func (b *BTSE) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, endpoint string, isSpot bool, values url.Values, req map[string]interface{}, result interface{}, f request.EndpointLimit) error {
...
func (b *BTSE) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func (b *BTSE) calculateTradingFee(ctx context.Context, feeBuilder *goex.FeeBuilder) float64 {

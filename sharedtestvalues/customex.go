...
func (c *CustomEx) GetFeeByType(_ context.Context, _ *goex.FeeBuilder) (float64, error) {
	return 0.0, nil
}
...
func (c *CustomEx) GetAccountFundingHistory(_ context.Context) ([]goex.FundingHistory, error) {
	return nil, nil
}
...
func (c *CustomEx) GetWithdrawalsHistory(_ context.Context, _ currency.Code, _ asset.Item) ([]goex.WithdrawalHistory, error) {
	return []goex.WithdrawalHistory{}, nil
}
...
func (c *CustomEx) GetBase() *goex.Base {
	return nil
}

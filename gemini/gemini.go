...
func (g *Gemini) GetSymbols(ctx context.Context) ([]string, error) {
	...
	return symbols, g.SendHTTPRequest(ctx, goex.RestSpot, path, &symbols)
}
...
func (g *Gemini) GetSymbolDetails(ctx context.Context, symbol string) ([]SymbolDetails, error) {
	if symbol == "all" {
		...
		return details, g.SendHTTPRequest(ctx, goex.RestSpot, "/v"+geminiAPIVersion+"/"+geminiSymbolDetails+"/"+symbol, &details)
	}
	var details SymbolDetails
	err := g.SendHTTPRequest(ctx, goex.RestSpot, "/v"+geminiAPIVersion+"/"+geminiSymbolDetails+"/"+symbol, &details)
	if err != nil {
		return nil, err
	}
...
func (g *Gemini) GetTicker(ctx context.Context, currencyPair string) (TickerV2, error) {
	...
	err := g.SendHTTPRequest(ctx, goex.RestSpot, path, &ticker)
	if err != nil {
		return ticker, err
	}
...
func (g *Gemini) GetOrderbook(ctx context.Context, currencyPair string, params url.Values) (*Orderbook, error) {
	...
	return &orderbook, g.SendHTTPRequest(ctx, goex.RestSpot, path, &orderbook)
}
...
func (g *Gemini) GetTrades(ctx context.Context, currencyPair string, since, limit int64, includeBreaks bool) ([]Trade, error) {
	...
	return trades, g.SendHTTPRequest(ctx, goex.RestSpot, path, &trades)
}
...
func (g *Gemini) GetAuction(ctx context.Context, currencyPair string) (Auction, error) {
	...
	return auction, g.SendHTTPRequest(ctx, goex.RestSpot, path, &auction)
}
...
func (g *Gemini) GetAuctionHistory(ctx context.Context, currencyPair string, params url.Values) ([]AuctionHistory, error) {
	...
	return auctionHist, g.SendHTTPRequest(ctx, goex.RestSpot, path, &auctionHist)
}
...
func (g *Gemini) NewOrder(ctx context.Context, symbol string, amount, price float64, side, orderType string) (int64, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiOrderNew, req, &response)
	if err != nil {
		return 0, err
	}
...
func (g *Gemini) Transfers(ctx context.Context, curr currency.Code, start time.Time, limit int64, account string, showCompletedDeposit bool) ([]TransferResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiTransfers, req, &response)
}
...
func (g *Gemini) CancelExistingOrder(ctx context.Context, orderID int64) (Order, error) {
	...
	response := Order{}
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiOrderCancel, req, &response)
	if err != nil {
		return Order{}, err
	}
	if response.Message != "" {
...
func (g *Gemini) CancelExistingOrders(ctx context.Context, cancelBySession bool) (OrderResult, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, path, nil, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) GetOrderStatus(ctx context.Context, orderID int64) (Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiOrderStatus, req, &response)
	if err != nil {
		return response, err
	}
...
func (g *Gemini) GetOrders(ctx context.Context) ([]Order, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiOrders, nil, &response)
	if err != nil {
		return nil, err
	}
...
func (g *Gemini) GetTradeHistory(ctx context.Context, currencyPair string, timestamp int64) ([]TradeHistory, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiMyTrades, req, &response)
}
...
func (g *Gemini) GetNotionalVolume(ctx context.Context) (NotionalVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiVolume, nil, &response)
}
...
func (g *Gemini) GetTradeVolume(ctx context.Context) ([][]TradeVolume, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiTradeVolume, nil, &response)
}
...
func (g *Gemini) GetBalances(ctx context.Context) ([]Balance, error) {
	...
	return response,
		g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiBalances, nil, &response)
}
...
func (g *Gemini) GetCryptoDepositAddress(ctx context.Context, depositAddlabel, currency string) (DepositAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiDeposit+"/"+currency+"/"+geminiNewAddress, req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) WithdrawCrypto(ctx context.Context, address, currency string, amount float64) (WithdrawalAddress, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiWithdraw+strings.ToLower(currency), req, &response)
	if err != nil {
		return response, err
	}
	if response.Message != "" {
...
func (g *Gemini) PostHeartbeat(ctx context.Context) (string, error) {
	...
	err := g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, geminiHeartbeat, nil, &response)
	if err != nil {
...
func (g *Gemini) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (g *Gemini) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, path string, params map[string]interface{}, result interface{}) (err error) {
...
func (g *Gemini) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

...
func TestFormatWithdrawPermissions(t *testing.T) {
	t.Parallel()
	expectedResult := goex.AutoWithdrawCryptoWithAPIPermissionText +
		" & " +
		goex.AutoWithdrawCryptoWithSetupText +
		" & " +
		goex.WithdrawFiatViaWebsiteOnlyText
...
func TestWsAuth(t *testing.T) {
	t.Parallel()
	err := g.API.Endpoints.SetRunning(goex.WebsocketSpot.String(), geminiWebsocketSandboxEndpoint)
	if err != nil {
		t.Error(err)
	}

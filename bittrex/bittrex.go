...
func (b *Bittrex) GetMarkets(ctx context.Context) ([]MarketData, error) {
	var resp []MarketData
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, getMarkets, &resp, nil)
}
...
func (b *Bittrex) GetCurrencies(ctx context.Context) ([]CurrencyData, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, getCurrencies, &resp, nil)
}
...
func (b *Bittrex) GetTicker(ctx context.Context, marketName string) (TickerData, error) {
	var resp TickerData
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getTicker, marketName), &resp, nil)
}

// GetTickers returns bittrex tickers
func (b *Bittrex) GetTickers(ctx context.Context) ([]TickerData, error) {
	var resp []TickerData
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, getTickers, &resp, nil)
}
...
func (b *Bittrex) GetMarketSummaries(ctx context.Context) ([]MarketSummaryData, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, getMarketSummaries, &resp, nil)
}
...
func (b *Bittrex) GetMarketSummary(ctx context.Context, marketName string) (MarketSummaryData, error) {
	var resp MarketSummaryData
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getMarketSummary, marketName), &resp, nil)
}
...
func (b *Bittrex) GetOrderbook(ctx context.Context, marketName string, depth int64) (*OrderbookData, int64, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getOrderbook, marketName, strDepth), &resp, &resultHeader)
	if err != nil {
		return nil, 0, err
	}
...
func (b *Bittrex) GetMarketHistory(ctx context.Context, currency string) ([]TradeData, error) {
	var resp []TradeData
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getMarketTrades, currency), &resp, nil)
}
...
func (b *Bittrex) Order(ctx context.Context, marketName, side, orderType string, timeInForce TimeInForce, price, amount, ceiling float64) (OrderData, error) {
	...
	var resp OrderData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodPost, submitOrder, nil, req, &resp, nil)
}
...
func (b *Bittrex) GetOpenOrders(ctx context.Context, marketName string) ([]OrderData, int64, error) {
	...
	var sequence int64
	resultHeader := http.Header{}
	err := b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, nil, nil, &resp, &resultHeader)
	if err != nil {
		return nil, 0, err
	}
	sequence, err = strconv.ParseInt(resultHeader.Get("sequence"), 10, 64)
...
func (b *Bittrex) CancelExistingOrder(ctx context.Context, uuid string) (OrderData, error) {
	var resp OrderData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, fmt.Sprintf(cancelOrder, uuid), nil, nil, &resp, nil)
}
...
func (b *Bittrex) CancelOpenOrders(ctx context.Context, market string) ([]BulkCancelResultData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, cancelOpenOrders, params, nil, &resp, nil)
}
...
func (b *Bittrex) GetRecentCandles(ctx context.Context, marketName, candleInterval, candleType string) ([]CandleData, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getRecentCandles, marketName, candleType, candleInterval), &resp, nil)
}
...
func (b *Bittrex) GetHistoricalCandles(ctx context.Context, marketName, candleInterval, candleType string, year, month, day int) ([]CandleData, error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, fmt.Sprintf(getHistoricalCandles, marketName, candleType, candleInterval, start), &resp, nil)
}

// GetBalances is used to retrieve all balances from your account
func (b *Bittrex) GetBalances(ctx context.Context) ([]BalanceData, error) {
	var resp []BalanceData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getBalances, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetAccountBalanceByCurrency(ctx context.Context, currency string) (BalanceData, error) {
	var resp BalanceData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, fmt.Sprintf(getBalance, currency), nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetCryptoDepositAddresses(ctx context.Context) ([]AddressData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, depositAddresses, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetCryptoDepositAddress(ctx context.Context, currency string) (AddressData, error) {
	var resp AddressData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, fmt.Sprintf(getDepositAddress, currency), nil, nil, &resp, nil)
}
...
func (b *Bittrex) ProvisionNewDepositAddress(ctx context.Context, currency string) (*ProvisionNewAddressData, error) {
	...
	return &resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodPost, depositAddresses, nil, req, &resp, nil)
}
...
func (b *Bittrex) Withdraw(ctx context.Context, currency, paymentID, address string, quantity float64) (WithdrawalData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodPost, submitWithdrawal, nil, req, &resp, nil)
}
...
func (b *Bittrex) GetOrder(ctx context.Context, uuid string) (OrderData, error) {
	var resp OrderData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, fmt.Sprintf(getOrder, uuid), nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetOrderHistoryForCurrency(ctx context.Context, currency string) ([]OrderData, error) {
	var resp []OrderData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, fmt.Sprintf(getClosedOrders, currency), nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetClosedWithdrawals(ctx context.Context) ([]WithdrawalData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getClosedWithdrawals, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetClosedWithdrawalsForCurrency(ctx context.Context, currency string) ([]WithdrawalData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getClosedWithdrawals, params, nil, &resp, nil)
}
...
func (b *Bittrex) GetOpenWithdrawals(ctx context.Context) ([]WithdrawalData, error) {
	var resp []WithdrawalData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getOpenWithdrawals, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetClosedDeposits(ctx context.Context) ([]DepositData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getClosedDeposits, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetClosedDepositsForCurrency(ctx context.Context, currency string) ([]DepositData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getClosedDeposits, params, nil, &resp, nil)
}
...
func (b *Bittrex) GetOpenDeposits(ctx context.Context) ([]DepositData, error) {
	var resp []DepositData
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getOpenDeposits, nil, nil, &resp, nil)
}
...
func (b *Bittrex) GetOpenDepositsForCurrency(ctx context.Context, currency string) ([]DepositData, error) {
	...
	return resp, b.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, getOpenDeposits, params, nil, &resp, nil)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (b *Bittrex) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}, resultHeader *http.Header) error {
...
func (b *Bittrex) SendAuthHTTPRequest(ctx context.Context, ep goex.URL, method, action string, params url.Values, data, result interface{}, resultHeader *http.Header) error {
...
func (b *Bittrex) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
	var err error

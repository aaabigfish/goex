...
func (by *Bybit) GetAllSpotPairs(ctx context.Context) ([]PairData, error) {
	...
	return resp.Data, by.SendHTTPRequest(ctx, goex.RestSpot, bybitSpotGetSymbols, publicSpotRate, &resp)
}
...
func (by *Bybit) GetOrderBook(ctx context.Context, symbol string, depth int64) (*Orderbook, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, path, publicSpotRate, &o)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) GetTrades(ctx context.Context, symbol string, limit int64) ([]TradeItem, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, path, publicSpotRate, &resp)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) GetKlines(ctx context.Context, symbol, period string, limit int64, start, end time.Time) ([]KlineItem, error) {
	...
	if err := by.SendHTTPRequest(ctx, goex.RestSpot, path, publicSpotRate, &resp); err != nil {
		return nil, err
	}
...
func (by *Bybit) Get24HrsChange(ctx context.Context, symbol string) ([]PriceChangeStats, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, bybit24HrsChange, publicSpotRate, &resp)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) GetLastTradedPrice(ctx context.Context, symbol string) ([]LastTradePrice, error) {
	...
	if symbol != "" {
		...
		err := by.SendHTTPRequest(ctx, goex.RestSpot, bybitLastTradedPrice, publicSpotRate, &resp)
		if err != nil {
			return nil, err
		}
		for x := range resp.Data {
...
func (by *Bybit) GetBestBidAskPrice(ctx context.Context, symbol string) ([]TickerData, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, bybitBestBidAskPrice, publicSpotRate, &resp)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) GetTickersV5(ctx context.Context, category, symbol, baseCoin string) (*ListOfTickers, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, bybitGetTickersV5+"?"+val.Encode(), publicSpotRate, &result)
	if err != nil {
		return nil, err
	}
...
// https://bybit-goex.github.io/docs/v5/market/instrument
func (by *Bybit) GetInstrumentInfo(ctx context.Context, category, symbol, status, baseCoin, cursor string, limit int64) (*GetInstrumentInfoResponse, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, bybitInstrumentInfoV5+"?"+val.Encode(), publicSpotRate, &result)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) CreatePostOrder(ctx context.Context, o *PlaceOrderRequest) (*PlaceOrderResponse, error) {
	...
	return &resp.Data, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodPost, bybitSpotOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) QueryOrder(ctx context.Context, orderID, orderLinkID string) (*QueryOrderResponse, error) {
	...
	return &resp.Data, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitSpotOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) CancelExistingOrder(ctx context.Context, orderID, orderLinkID string) (*CancelOrderResponse, error) {
	...
	err := by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, bybitSpotOrder, params, nil, &resp, privateSpotRate)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) FastCancelExistingOrder(ctx context.Context, symbol, orderID, orderLinkID string) (bool, error) {
	...
	return resp.Data.IsCancelled, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, bybitFastCancelSpotOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) BatchCancelOrder(ctx context.Context, symbol, side, orderTypes string) (bool, error) {
	...
	return resp.Result.Success, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, bybitBatchCancelSpotOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) BatchFastCancelOrder(ctx context.Context, symbol, side, orderTypes string) (bool, error) {
	...
	return resp.Result.Success, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, bybitFastBatchCancelSpotOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) BatchCancelOrderByIDs(ctx context.Context, orderIDs []string) (bool, error) {
	...
	return resp.Result.Success, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, bybitBatchCancelByIDs, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) ListOpenOrders(ctx context.Context, symbol, orderID string, limit int64) ([]QueryOrderResponse, error) {
	...
	return resp.Data, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitOpenOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) GetPastOrders(ctx context.Context, symbol, orderID string, limit int64, startTime, endTime time.Time) ([]QueryOrderResponse, error) {
	...
	return resp.Data, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitPastOrder, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) GetTradeHistory(ctx context.Context, limit int64, symbol, fromID, toID, orderID string, startTime, endTime time.Time) ([]HistoricalTrade, error) {
	...
	return resp.Data, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitTradeHistory, params, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) GetWalletBalance(ctx context.Context) ([]Balance, error) {
	...
	return resp.Data.Balances, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitWalletBalance, url.Values{}, nil, &resp, privateSpotRate)
}
...
func (by *Bybit) GetSpotServerTime(ctx context.Context) (time.Time, error) {
	...
	err := by.SendHTTPRequest(ctx, goex.RestSpot, bybitServerTime, publicSpotRate, &resp)
...
func (by *Bybit) GetDepositAddressForCurrency(ctx context.Context, coin string) (DepositWalletInfo, error) {
	...
	return resp.Result, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, bybitGetDepositAddress, params, nil, &resp, publicSpotRate)
}
...
func (by *Bybit) WithdrawFund(ctx context.Context, coin, chain, address, tag, amount string) (string, error) {
	...
	return resp.Data.ID, by.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodPost, bybitWithdrawFund, nil, params, &resp, privateSpotRate)
}
...
func (by *Bybit) GetFeeRate(ctx context.Context, category, symbol, baseCoin string) (*AccountFee, error) {
	...
	err := by.SendAuthHTTPRequestV5(ctx, goex.RestSpot, http.MethodGet, bybitAccountFee, params, &result, privateFeeRate)
	if err != nil {
		return nil, err
	}
...
func (by *Bybit) SendHTTPRequest(ctx context.Context, ePath goex.URL, path string, f request.EndpointLimit, result UnmarshalTo) error {
...
func (by *Bybit) SendAuthHTTPRequest(ctx context.Context, ePath goex.URL, method, path string, params url.Values, jsonPayload map[string]interface{}, result UnmarshalTo, f request.EndpointLimit) error {
...
func (by *Bybit) SendAuthHTTPRequestV5(ctx context.Context, ePath goex.URL, method, path string, params url.Values, result UnmarshalTo, f request.EndpointLimit) error {
	creds, err := by.GetCredentials(ctx)
	if err != nil {
		return err
	}

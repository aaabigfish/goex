...
func (g *Gateio) CreateNewSubAccount(ctx context.Context, arg SubAccountParams) (*SubAccount, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, http.MethodPost, subAccounts, nil, &arg, &response)
}
...
func (g *Gateio) GetSubAccounts(ctx context.Context) ([]SubAccount, error) {
	var response []SubAccount
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, http.MethodGet, subAccounts, nil, nil, &response)
}
...
func (g *Gateio) GetSingleSubAccount(ctx context.Context, userID string) (*SubAccount, error) {
	...
	var response *SubAccount
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, http.MethodGet,
...
func (g *Gateio) CreateAPIKeysOfSubAccount(ctx context.Context, arg CreateAPIKeySubAccountParams) (*CreateAPIKeyResponse, error) {
	...
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, "sub_accounts/"+strconv.FormatInt(arg.SubAccountUserID, 10)+"/keys", nil, &arg, &resp)
}
...
func (g *Gateio) GetAllAPIKeyOfSubAccount(ctx context.Context, userID int64) ([]CreateAPIKeyResponse, error) {
	var resp []CreateAPIKeyResponse
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, "sub_accounts/"+strconv.FormatInt(userID, 10)+"/keys", nil, nil, &resp)
}
...
func (g *Gateio) UpdateAPIKeyOfSubAccount(ctx context.Context, subAccountAPIKey string, arg CreateAPIKeySubAccountParams) error {
	return g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPut, "sub_accounts/"+strconv.FormatInt(arg.SubAccountUserID, 10)+"/keys/"+subAccountAPIKey, nil, &arg, nil)
}
...
func (g *Gateio) GetAPIKeyOfSubAccount(ctx context.Context, subAccountUserID int64, apiKey string) (*CreateAPIKeyResponse, error) {
	...
	var resp *CreateAPIKeyResponse
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, "sub_accounts/"+strconv.FormatInt(subAccountUserID, 10)+"/keys/"+apiKey, nil, nil, &resp)
}
...
func (g *Gateio) LockSubAccount(ctx context.Context, subAccountUserID int64) error {
	...
	return g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodPost, "sub_accounts/"+strconv.FormatInt(subAccountUserID, 10)+"/lock", nil, nil, nil)
}
...
func (g *Gateio) UnlockSubAccount(ctx context.Context, subAccountUserID int64) error {
	...
	return g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodPost, "sub_accounts/"+strconv.FormatInt(subAccountUserID, 10)+"/unlock", nil, nil, nil)
}
...
func (g *Gateio) ListSpotCurrencies(ctx context.Context) ([]CurrencyInfo, error) {
	...
	return resp, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioSpotCurrencies, &resp)
}
...
func (g *Gateio) GetCurrencyDetail(ctx context.Context, ccy currency.Code) (*CurrencyInfo, error) {
	...
	var resp *CurrencyInfo
	return resp, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL,
		gateioSpotCurrencies+"/"+ccy.String(), &resp)
}

// ListSpotCurrencyPairs retrieve all currency pairs supported by the goex.
func (g *Gateio) ListSpotCurrencyPairs(ctx context.Context) ([]CurrencyPairDetail, error) {
	var resp []CurrencyPairDetail
	return resp, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioSpotCurrencyPairs, &resp)
}
...
func (g *Gateio) GetTickers(ctx context.Context, currencyPair, timezone string) ([]Ticker, error) {
	...
	var tickers []Ticker
	return tickers, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, common.EncodeURLValues(gateioSpotTickers, params), &tickers)
}
...
func (g *Gateio) GetOrderbook(ctx context.Context, pairString, interval string, limit uint64, withOrderbookID bool) (*Orderbook, error) {
	...
	err := g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, common.EncodeURLValues(gateioSpotOrderbook, params), &response)
	if err != nil {
		return nil, err
	}
...
func (g *Gateio) GetMarketTrades(ctx context.Context, pairString currency.Pair, limit uint64, lastID string, reverse bool, from, to time.Time, page uint64) ([]Trade, error) {
	...
	var response []Trade
	return response, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL,
...
func (g *Gateio) GetCandlesticks(ctx context.Context, currencyPair currency.Pair, limit uint64, from, to time.Time, interval kline.Interval) ([]Candlestick, error) {
	...
	err = g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, common.EncodeURLValues(gateioSpotCandlesticks, params), &candles)
	if err != nil {
		return nil, err
	}
	if len(candles) == 0 {
...
func (g *Gateio) GetTradingFeeRatio(ctx context.Context, currencyPair currency.Pair) (*SpotTradingFeeRate, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotFeeRate, params, nil, &response)
}
...
func (g *Gateio) GetSpotAccounts(ctx context.Context, ccy currency.Code) ([]SpotAccount, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotAccounts, params, nil, &response)
}
...
func (g *Gateio) CreateBatchOrders(ctx context.Context, args []CreateOrderRequestData) ([]SpotOrder, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioSpotBatchOrders, nil, &args, &response)
}
...
func (g *Gateio) GateioSpotOpenOrders(ctx context.Context, page, limit uint64, isCrossMargin bool) ([]SpotOrdersDetail, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotOpenOrders, params, nil, &response)
}
...
func (g *Gateio) SpotClosePositionWhenCrossCurrencyDisabled(ctx context.Context, arg *ClosePositionRequestParam) (*SpotOrder, error) {
	...
	var response *SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL,
...
func (g *Gateio) PlaceSpotOrder(ctx context.Context, arg *CreateOrderRequestData) (*SpotOrder, error) {
	...
	var response *SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioSpotOrders, nil, &arg, &response)
}
...
func (g *Gateio) GetSpotOrders(ctx context.Context, currencyPair currency.Pair, status string, page, limit uint64) ([]SpotOrder, error) {
	...
	var response []SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodGet, gateioSpotOrders, params, nil, &response)
}
...
func (g *Gateio) CancelAllOpenOrdersSpecifiedCurrencyPair(ctx context.Context, currencyPair currency.Pair, side order.Side, account asset.Item) ([]SpotOrder, error) {
	...
	var response []SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, spotCancelOrdersEPL, http.MethodDelete, gateioSpotOrders, params, nil, &response)
}
...
func (g *Gateio) CancelBatchOrdersWithIDList(ctx context.Context, args []CancelOrderByIDParam) ([]CancelOrderByIDResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotCancelOrdersEPL, http.MethodPost, gateioSpotCancelBatchOrders, nil, &args, &response)
}
...
func (g *Gateio) GetSpotOrder(ctx context.Context, orderID string, currencyPair currency.Pair, account asset.Item) (*SpotOrder, error) {
	...
	var response *SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotOrders+"/"+orderID, params, nil, &response)
}
...
func (g *Gateio) AmendSpotOrder(ctx context.Context, orderID string, currencyPair currency.Pair, isCrossMarginAccount bool, arg *PriceAndAmount) (*SpotOrder, error) {
	...
	var resp *SpotOrder
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPatch, gateioSpotOrders+"/"+orderID, params, arg, &resp)
}
...
func (g *Gateio) CancelSingleSpotOrder(ctx context.Context, orderID, currencyPair string, isCrossMarginAccount bool) (*SpotOrder, error) {
	...
	var response *SpotOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, spotCancelOrdersEPL, http.MethodDelete, gateioSpotOrders+"/"+orderID, params, nil, &response)
}
...
func (g *Gateio) GateIOGetPersonalTradingHistory(ctx context.Context, currencyPair currency.Pair,
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotMyTrades, params, nil, &response)
}
...
func (g *Gateio) GetServerTime(ctx context.Context, _ asset.Item) (time.Time, error) {
	...
	err := g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioSpotServerTime, &resp)
	if err != nil {
...
func (g *Gateio) CountdownCancelorders(ctx context.Context, arg CountdownCancelOrderParam) (*TriggerTimeResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotCancelOrdersEPL, http.MethodPost, gateioSpotAllCountdown, nil, &arg, &response)
}
...
func (g *Gateio) CreatePriceTriggeredOrder(ctx context.Context, arg *PriceTriggeredOrderParam) (*OrderID, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioSpotPriceOrders, nil, &arg, &response)
}
...
func (g *Gateio) GetPriceTriggeredOrderList(ctx context.Context, status string, market currency.Pair, account asset.Item, offset, limit uint64) ([]SpotPriceTriggeredOrder, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotPriceOrders, params, nil, &response)
}
...
func (g *Gateio) CancelMultipleSpotOpenOrders(ctx context.Context, currencyPair currency.Pair, account asset.Item) ([]SpotPriceTriggeredOrder, error) {
	...
	var response []SpotPriceTriggeredOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotCancelOrdersEPL, http.MethodDelete, gateioSpotPriceOrders, params, nil, &response)
}
...
func (g *Gateio) GetSinglePriceTriggeredOrder(ctx context.Context, orderID string) (*SpotPriceTriggeredOrder, error) {
	...
	var response *SpotPriceTriggeredOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioSpotPriceOrders+"/"+orderID, nil, nil, &response)
}
...
func (g *Gateio) CancelPriceTriggeredOrder(ctx context.Context, orderID string) (*SpotPriceTriggeredOrder, error) {
	...
	var response *SpotPriceTriggeredOrder
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotCancelOrdersEPL, http.MethodGet, gateioSpotPriceOrders+"/"+orderID, nil, nil, &response)
}
...
func (g *Gateio) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, epl request.EndpointLimit, method, endpoint string, param url.Values, data, result interface{}) error {
...
func (g *Gateio) SendHTTPRequest(ctx context.Context, ep goex.URL, epl request.EndpointLimit, path string, result interface{}) error {
...
func (g *Gateio) WithdrawCurrency(ctx context.Context, arg WithdrawalRequestParam) (*WithdrawalResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, withdrawalEPL, http.MethodPost, withdrawal, nil, &arg, &response)
}
...
func (g *Gateio) CancelWithdrawalWithSpecifiedID(ctx context.Context, withdrawalID string) (*WithdrawalResponse, error) {
	...
	var response *WithdrawalResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, withdrawalEPL, http.MethodDelete, withdrawal+"/"+withdrawalID, nil, nil, &response)
}
...
func (g *Gateio) ListCurrencyChain(ctx context.Context, ccy currency.Code) ([]CurrencyChain, error) {
	...
	return resp, g.SendHTTPRequest(ctx, goex.RestSpot, walletEPL, common.EncodeURLValues(walletCurrencyChain, params), &resp)
}
...
func (g *Gateio) GenerateCurrencyDepositAddress(ctx context.Context, ccy currency.Code) (*CurrencyDepositAddressInfo, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL,
...
func (g *Gateio) GetWithdrawalRecords(ctx context.Context, ccy currency.Code, from, to time.Time, offset, limit uint64) ([]WithdrawalResponse, error) {
	...
	return withdrawals, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL,
...
func (g *Gateio) GetDepositRecords(ctx context.Context, ccy currency.Code, from, to time.Time, offset, limit uint64) ([]DepositRecord, error) {
	...
	return depositHistories, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL,
...
func (g *Gateio) TransferCurrency(ctx context.Context, arg *TransferCurrencyParam) (*TransactionIDResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodPost, walletTransfer, nil, &arg, &response)
}
...
func (g *Gateio) SubAccountTransfer(ctx context.Context, arg SubAccountTransferParam) error {
	...
	return g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodPost, walletSubAccountTransfer, nil, &arg, nil)
}
...
func (g *Gateio) SubAccountTransferToSubAccount(ctx context.Context, arg *InterSubAccountTransferParams) error {
	...
	return g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodPost, walletInterSubAccountTransfer, nil, &arg, nil)
}
...
func (g *Gateio) GetWithdrawalStatus(ctx context.Context, ccy currency.Code) ([]WithdrawalStatus, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletWithdrawStatus, params, nil, &response)
}
...
func (g *Gateio) GetSubAccountBalances(ctx context.Context, subAccountUserID string) ([]FuturesSubAccountBalance, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletSubAccountBalance, params, nil, &response)
}
...
func (g *Gateio) GetSubAccountMarginBalances(ctx context.Context, subAccountUserID string) ([]SubAccountMarginBalance, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletSubAccountMarginBalance, params, nil, &response)
}
...
func (g *Gateio) GetSubAccountFuturesBalances(ctx context.Context, subAccountUserID, settle string) ([]FuturesSubAccountBalance, error) {
	...
	var response []FuturesSubAccountBalance
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletSubAccountFuturesBalance, params, nil, &response)
}
...
func (g *Gateio) GetSubAccountCrossMarginBalances(ctx context.Context, subAccountUserID string) ([]SubAccountCrossMarginInfo, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletSubAccountCrossMarginBalances, params, nil, &response)
}
...
func (g *Gateio) GetSavedAddresses(ctx context.Context, ccy currency.Code, chain string, limit uint64) ([]WalletSavedAddress, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletSavedAddress, params, nil, &response)
}
...
func (g *Gateio) GetPersonalTradingFee(ctx context.Context, currencyPair currency.Pair, settle string) (*PersonalTradingFee, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletTradingFee, params, nil, &response)
}
...
func (g *Gateio) GetUsersTotalBalance(ctx context.Context, ccy currency.Code) (*UsersAllAccountBalance, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, walletEPL, http.MethodGet, walletTotalBalance, params, nil, &response)
}
...
func (g *Gateio) GetMarginSupportedCurrencyPairs(ctx context.Context) ([]MarginCurrencyPairInfo, error) {
	...
	return currenciePairsInfo, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioMarginCurrencyPairs, &currenciePairsInfo)
}
...
func (g *Gateio) GetSingleMarginSupportedCurrencyPair(ctx context.Context, market currency.Pair) (*MarginCurrencyPairInfo, error) {
	...
	return currencyPairInfo, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioMarginCurrencyPairs+"/"+market.String(), &currencyPairInfo)
}
...
func (g *Gateio) GetOrderbookOfLendingLoans(ctx context.Context, ccy currency.Code) ([]OrderbookOfLendingLoan, error) {
	...
	return lendingLoans, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL,
...
func (g *Gateio) GetMarginAccountList(ctx context.Context, currencyPair currency.Pair) ([]MarginAccountItem, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginAccount, params, nil, &response)
}
...
func (g *Gateio) ListMarginAccountBalanceChangeHistory(ctx context.Context, ccy currency.Code, currencyPair currency.Pair, from, to time.Time, page, limit uint64) ([]MarginAccountBalanceChangeInfo, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginAccountBook, params, nil, &response)
}
...
func (g *Gateio) GetMarginFundingAccountList(ctx context.Context, ccy currency.Code) ([]MarginFundingAccountItem, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginFundingAccounts, params, nil, &response)
}
...
func (g *Gateio) MarginLoan(ctx context.Context, arg *MarginLoanRequestParam) (*MarginLoanResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioMarginLoans, nil, &arg, &response)
}
...
func (g *Gateio) GetMarginAllLoans(ctx context.Context, status, side, sortBy string, ccy currency.Code, currencyPair currency.Pair, reverseSort bool, page, limit uint64) ([]MarginLoanResponse, error) {
	...
	var response []MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginLoans, params, nil, &response)
}
...
func (g *Gateio) MergeMultipleLendingLoans(ctx context.Context, ccy currency.Code, ids []string) (*MarginLoanResponse, error) {
	...
	var response *MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioMarginMergedLoans, params, nil, &response)
}
...
func (g *Gateio) RetriveOneSingleLoanDetail(ctx context.Context, side, loanID string) (*MarginLoanResponse, error) {
	...
	params.Set("side", side)
	var response *MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginLoans+"/"+loanID+"/", params, nil, &response)
}
...
func (g *Gateio) ModifyALoan(ctx context.Context, loanID string, arg *ModifyLoanRequestParam) (*MarginLoanResponse, error) {
	...
	var response *MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPatch, gateioMarginLoans+"/"+loanID, nil, &arg, &response)
}
...
func (g *Gateio) CancelLendingLoan(ctx context.Context, ccy currency.Code, loanID string) (*MarginLoanResponse, error) {
	...
	params.Set("currency", ccy.String())
	var response *MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodDelete, gateioMarginLoans+"/"+loanID, params, nil, &response)
}
...
func (g *Gateio) RepayALoan(ctx context.Context, loanID string, arg *RepayLoanRequestParam) (*MarginLoanResponse, error) {
	...
	var response *MarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioMarginLoans+"/"+loanID+"/repayment", nil, &arg, &response)
}
...
func (g *Gateio) ListLoanRepaymentRecords(ctx context.Context, loanID string) ([]LoanRepaymentRecord, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginLoans+"/"+loanID+"/repayment", nil, nil, &response)
}
...
func (g *Gateio) ListRepaymentRecordsOfSpecificLoan(ctx context.Context, loanID, status string, page, limit uint64) ([]LoanRecord, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginLoanRecords, params, nil, &response)
}
...
func (g *Gateio) GetOneSingleLoanRecord(ctx context.Context, loanID, loanRecordID string) (*LoanRecord, error) {
	...
	params.Set("loan_id", loanID)
	var response *LoanRecord
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginLoanRecords+"/"+loanRecordID, params, nil, &response)
}
...
func (g *Gateio) ModifyALoanRecord(ctx context.Context, loanRecordID string, arg *ModifyLoanRequestParam) (*LoanRecord, error) {
	...
	var response *LoanRecord
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPatch, gateioMarginLoanRecords+"/"+loanRecordID, nil, &arg, &response)
}
...
func (g *Gateio) UpdateUsersAutoRepaymentSetting(ctx context.Context, statusOn bool) (*OnOffStatus, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioMarginAutoRepay, params, nil, &response)
}
...
func (g *Gateio) GetUserAutoRepaymentSetting(ctx context.Context) (*OnOffStatus, error) {
	var response *OnOffStatus
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginAutoRepay, nil, nil, &response)
}
...
func (g *Gateio) GetMaxTransferableAmountForSpecificMarginCurrency(ctx context.Context, ccy currency.Code, currencyPair currency.Pair) (*MaxTransferAndLoanAmount, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginTransfer, params, nil, &response)
}
...
func (g *Gateio) GetMaxBorrowableAmountForSpecificMarginCurrency(ctx context.Context, ccy currency.Code, currencyPair currency.Pair) (*MaxTransferAndLoanAmount, error) {
	...
	params.Set("currency", ccy.String())
	var response *MaxTransferAndLoanAmount
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioMarginBorrowable, params, nil, &response)
}
...
func (g *Gateio) CurrencySupportedByCrossMargin(ctx context.Context) ([]CrossMarginCurrencies, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginCurrencies, nil, nil, &response)
}
...
func (g *Gateio) GetCrossMarginSupportedCurrencyDetail(ctx context.Context, ccy currency.Code) (*CrossMarginCurrencies, error) {
	...
	var response *CrossMarginCurrencies
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginCurrencies+"/"+ccy.String(), nil, nil, &response)
}
...
func (g *Gateio) GetCrossMarginAccounts(ctx context.Context) (*CrossMarginAccount, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginAccounts, nil, nil, &response)
}
...
func (g *Gateio) GetCrossMarginAccountChangeHistory(ctx context.Context, ccy currency.Code, from, to time.Time, page, limit uint64, accountChangeType string) ([]CrossMarginAccountHistoryItem, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginAccountBook, params, nil, &response)
}
...
func (g *Gateio) CreateCrossMarginBorrowLoan(ctx context.Context, arg CrossMarginBorrowLoanParams) (*CrossMarginLoanResponse, error) {
	...
	return &response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioCrossMarginLoans, nil, &arg, &response)
}
...
func (g *Gateio) ExecuteRepayment(ctx context.Context, arg CurrencyAndAmount) ([]CrossMarginLoanResponse, error) {
	...
	var response []CrossMarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPlaceOrdersEPL, http.MethodPost, gateioCrossMarginRepayments, nil, &arg, &response)
}
...
func (g *Gateio) GetCrossMarginRepayments(ctx context.Context, ccy currency.Code, loanID string, limit, offset uint64, reverse bool) ([]CrossMarginLoanResponse, error) {
	...
	var response []CrossMarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginRepayments, params, nil, &response)
}
...
func (g *Gateio) GetMaxTransferableAmountForSpecificCrossMarginCurrency(ctx context.Context, ccy currency.Code) (*CurrencyAndAmount, error) {
	...
	params.Set("currency", ccy.String())
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginTransferable, params, nil, &response)
}
...
func (g *Gateio) GetMaxBorrowableAmountForSpecificCrossMarginCurrency(ctx context.Context, ccy currency.Code) (*CurrencyAndAmount, error) {
	...
	params.Set("currency", ccy.String())
	var response *CurrencyAndAmount
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginBorrowable, params, nil, &response)
}
...
func (g *Gateio) GetCrossMarginBorrowHistory(ctx context.Context, status uint64, ccy currency.Code, limit, offset uint64, reverse bool) ([]CrossMarginLoanResponse, error) {
	...
	var response []CrossMarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginLoans, params, nil, &response)
}
...
func (g *Gateio) GetSingleBorrowLoanDetail(ctx context.Context, loanID string) (*CrossMarginLoanResponse, error) {
	...
	var response *CrossMarginLoanResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioCrossMarginLoans+"/"+loanID, nil, nil, &response)
}
...
func (g *Gateio) GetAllFutureContracts(ctx context.Context, settle string) ([]FuturesContract, error) {
	...
	return contracts, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, "futures/"+settle+"/contracts", &contracts)
}
...
func (g *Gateio) GetSingleContract(ctx context.Context, settle, contract string) (*FuturesContract, error) {
	...
	return futureContract, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, "futures/"+settle+"/contracts/"+contract, &futureContract)
}
...
func (g *Gateio) GetFuturesOrderbook(ctx context.Context, settle, contract, interval string, limit uint64, withOrderbookID bool) (*Orderbook, error) {
	...
	return response, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("futures/"+settle+"/order_book", params), &response)
}
...
func (g *Gateio) GetFuturesTradingHistory(ctx context.Context, settle string, contract currency.Pair, limit, offset uint64, lastID string, from, to time.Time) ([]TradingHistoryItem, error) {
	...
	return response, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetFuturesCandlesticks(ctx context.Context, settle, contract string, from, to time.Time, limit uint64, interval kline.Interval) ([]FuturesCandlestick, error) {
	...
	return candlesticks, g.SendHTTPRequest(ctx, goex.RestFutures, perpetualSwapDefaultEPL,
...
func (g *Gateio) PremiumIndexKLine(ctx context.Context, settleCurrency string, contract currency.Pair, from, to time.Time, limit int64, interval kline.Interval) ([]FuturesPremiumIndexKLineResponse, error) {
	...
	return resp, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("futures/"+settleCurrency+"/premium_index", params), &resp)
}
...
func (g *Gateio) GetFuturesTickers(ctx context.Context, settle string, contract currency.Pair) ([]FuturesTicker, error) {
	...
	return tickers, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("futures/"+settle+"/tickers", params), &tickers)
}
...
func (g *Gateio) GetFutureFundingRates(ctx context.Context, settle string, contract currency.Pair, limit uint64) ([]FuturesFundingRate, error) {
	...
	return rates, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("futures/"+settle+"/funding_rate", params), &rates)
}
...
func (g *Gateio) GetFuturesInsuranceBalanceHistory(ctx context.Context, settle string, limit uint64) ([]InsuranceBalance, error) {
	...
	return balances, g.SendHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) QueryFuturesAccount(ctx context.Context, settle string) (*FuturesAccount, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, "futures/"+settle+"/accounts", nil, nil, &response)
}
...
func (g *Gateio) GetFuturesAccountBooks(ctx context.Context, settle string, limit uint64, from, to time.Time, changingType string) ([]AccountBookItem, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL,
...
func (g *Gateio) GetAllFuturesPositionsOfUsers(ctx context.Context, settle string) (*Position, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, "futures/"+settle+"/positions", nil, nil, &response)
}
...
func (g *Gateio) UpdateFuturesPositionMargin(ctx context.Context, settle string, change float64, contract currency.Pair) (*Position, error) {
	...
	var response *Position
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapPlaceOrdersEPL,
...
func (g *Gateio) UpdateFuturesPositionLeverage(ctx context.Context, settle string, contract currency.Pair, leverage, crossLeverageLimit float64) (*Position, error) {
	...
	var response *Position
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapPlaceOrdersEPL, http.MethodPost,
...
func (g *Gateio) UpdateFuturesPositionRiskLimit(ctx context.Context, settle string, contract currency.Pair, riskLimit uint64) (*Position, error) {
	...
	var response *Position
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPlaceOrdersEPL,
...
func (g *Gateio) RetrivePositionDetailInDualMode(ctx context.Context, settle string, contract currency.Pair) ([]Position, error) {
	...
	var response []Position
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet,
...
func (g *Gateio) UpdatePositionLeverageInDualMode(ctx context.Context, settle string, contract currency.Pair, leverage, crossLeverageLimit float64) (*Position, error) {
	...
	var response *Position
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPlaceOrdersEPL, http.MethodPost, "futures/"+settle+"/dual_comp/positions/"+contract.String()+"/leverage", params, nil, &response)
}
...
func (g *Gateio) CancelMultipleFuturesOpenOrders(ctx context.Context, contract currency.Pair, side, settle string) ([]Order, error) {
	...
	params.Set("contract", contract.String())
	var response []Order
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapCancelOrdersEPL,
...
func (g *Gateio) GetSingleFuturesOrder(ctx context.Context, settle, orderID string) (*Order, error) {
	...
	var response *Order
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapPrivateEPL,
...
func (g *Gateio) CancelSingleFuturesOrder(ctx context.Context, settle, orderID string) (*Order, error) {
	...
	var response *Order
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapCancelOrdersEPL, http.MethodDelete,
...
func (g *Gateio) AmendFuturesOrder(ctx context.Context, settle, orderID string, arg AmendFuturesOrderParam) (*Order, error) {
	...
	var response *Order
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPlaceOrdersEPL, http.MethodPut,
...
func (g *Gateio) GetMyPersonalTradingHistory(ctx context.Context, settle, lastID, orderID string, contract currency.Pair, limit, offset, countTotal uint64) ([]TradingHistoryItem, error) {
	...
	var response []TradingHistoryItem
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet,
...
func (g *Gateio) CreatePriceTriggeredFuturesOrder(ctx context.Context, settle string, arg *FuturesPriceTriggeredOrderParam) (*OrderID, error) {
	...
	var response *OrderID
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPlaceOrdersEPL, http.MethodPost,
...
func (g *Gateio) GetAllDeliveryContracts(ctx context.Context, settle string) ([]DeliveryContract, error) {
	...
	return contracts, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetSingleDeliveryContracts(ctx context.Context, settle string, contract currency.Pair) (*DeliveryContract, error) {
	...
	return deliveryContract, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetDeliveryOrderbook(ctx context.Context, settle, interval string, contract currency.Pair, limit uint64, withOrderbookID bool) (*Orderbook, error) {
	...
	return orderbook, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("delivery/"+settle+"/order_book", params), &orderbook)
}
...
func (g *Gateio) GetDeliveryTradingHistory(ctx context.Context, settle, lastID string, contract currency.Pair, limit uint64, from, to time.Time) ([]DeliveryTradingHistory, error) {
	...
	return histories, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetDeliveryFutureTickers(ctx context.Context, settle string, contract currency.Pair) ([]FuturesTicker, error) {
	...
	var tickers []FuturesTicker
	return tickers, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues("delivery/"+settle+"/tickers", params), &tickers)
}
...
func (g *Gateio) GetDeliveryInsuranceBalanceHistory(ctx context.Context, settle string, limit uint64) ([]InsuranceBalance, error) {
	...
	var balances []InsuranceBalance
	return balances, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL,
...
func (g *Gateio) GetDeliveryFuturesAccounts(ctx context.Context, settle string) (*FuturesAccount, error) {
	...
	var response *FuturesAccount
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, "delivery/"+settle+"/accounts", nil, nil, &response)
}
...
func (g *Gateio) GetDeliveryPriceTriggeredOrder(ctx context.Context, settle string, arg *FuturesPriceTriggeredOrderParam) (*OrderID, error) {
	...
	var response *OrderID
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodPost,
...
func (g *Gateio) GetAllOptionsUnderlyings(ctx context.Context) ([]OptionUnderlying, error) {
	...
	return response, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, gateioOptionUnderlyings, &response)
}
...
func (g *Gateio) GetExpirationTime(ctx context.Context, underlying string) (time.Time, error) {
	...
	err := g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, gateioOptionExpiration+"?underlying="+underlying, &timestamp)
	if err != nil {
		return time.Time{}, err
	}
	if len(timestamp) == 0 {
...
func (g *Gateio) GetAllContractOfUnderlyingWithinExpiryDate(ctx context.Context, underlying string, expTime time.Time) ([]OptionContract, error) {
	...
	return contracts, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues(gateioOptionContracts, params), &contracts)
}
...
func (g *Gateio) GetOptionsSpecifiedContractDetail(ctx context.Context, contract currency.Pair) (*OptionContract, error) {
	...
	return contr, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetSettlementHistory(ctx context.Context, underlying string, offset, limit uint64, from, to time.Time) ([]OptionSettlement, error) {
	...
	return settlements, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetOptionsSpecifiedContractsSettlement(ctx context.Context, contract currency.Pair, underlying string, at int64) (*OptionSettlement, error) {
	...
	return settlement, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues(gateioOptionSettlement+"/"+contract.String(), params), &settlement)
}
...
func (g *Gateio) GetMyOptionsSettlements(ctx context.Context, underlying string, contract currency.Pair, offset, limit uint64, to time.Time) ([]MyOptionSettlement, error) {
	...
	return settlements, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionMySettlements, params, nil, &settlements)
}
...
func (g *Gateio) GetOptionsOrderbook(ctx context.Context, contract currency.Pair, interval string, limit uint64, withOrderbookID bool) (*Orderbook, error) {
	...
	params.Set("with_id", strconv.FormatBool(withOrderbookID))
	var response *Orderbook
	return response, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues(gateioOptionsOrderbook, params), &response)
}
...
func (g *Gateio) GetOptionAccounts(ctx context.Context) (*OptionAccount, error) {
	...
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionAccounts, nil, nil, &resp)
}
...
func (g *Gateio) GetAccountChangingHistory(ctx context.Context, offset, limit uint64, from, to time.Time, changingType string) ([]AccountBook, error) {
	...
	return accountBook, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionsAccountbook, params, nil, &accountBook)
}
...
func (g *Gateio) GetUsersPositionSpecifiedUnderlying(ctx context.Context, underlying string) ([]UsersPositionForUnderlying, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionsPosition, params, nil, &response)
}
...
func (g *Gateio) GetUsersLiquidationHistoryForSpecifiedUnderlying(ctx context.Context, underlying string, contract currency.Pair) ([]ContractClosePosition, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionsPositionClose, params, nil, &response)
}
...
func (g *Gateio) CancelMultipleOptionOpenOrders(ctx context.Context, contract currency.Pair, underlying, side string) ([]OptionOrderResponse, error) {
	...
	var response []OptionOrderResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx,
		goex.RestSpot, perpetualSwapCancelOrdersEPL, http.MethodDelete, gateioOptionsOrders, params, nil, &response)
}
...
func (g *Gateio) GetSingleOptionOrder(ctx context.Context, orderID string) (*OptionOrderResponse, error) {
	...
	return o, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionsOrders+"/"+orderID, nil, nil, &o)
}
...
func (g *Gateio) GetOptionsPersonalTradingHistory(ctx context.Context, underlying string, contract currency.Pair, offset, limit uint64, from, to time.Time) ([]OptionTradingHistory, error) {
	...
	return resp, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, perpetualSwapPrivateEPL, http.MethodGet, gateioOptionsMyTrades, params, nil, &resp)
}
...
func (g *Gateio) GetOptionUnderlyingTickers(ctx context.Context, underlying string) (*OptionsUnderlyingTicker, error) {
	...
	return respos, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetOptionFuturesCandlesticks(ctx context.Context, contract currency.Pair, limit uint64, from, to time.Time, interval kline.Interval) ([]FuturesCandlestick, error) {
	...
	return candles, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL,
...
func (g *Gateio) GetOptionsTradeHistory(ctx context.Context, contract /*C is call, while P is put*/ currency.Pair, callType string, offset, limit uint64, from, to time.Time) ([]TradingHistoryItem, error) {
	...
	return trades, g.SendHTTPRequest(ctx, goex.RestSpot, perpetualSwapDefaultEPL, common.EncodeURLValues(gateioOptionsTrades, params), &trades)
}
...
func (g *Gateio) GetSupportedFlashSwapCurrencies(ctx context.Context) ([]SwapCurrencies, error) {
	...
	return currencies, g.SendHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, gateioFlashSwapCurrencies, &currencies)
}
...
func (g *Gateio) CreateFlashSwapOrder(ctx context.Context, arg FlashSwapOrderParams) (*FlashSwapOrderResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotDefaultEPL, http.MethodPost, gateioFlashSwapOrders, nil, &arg, &response)
}
...
func (g *Gateio) GetAllFlashSwapOrders(ctx context.Context, status int, sellCurrency, buyCurrency currency.Code, reverse bool, limit, page uint64) ([]FlashSwapOrderResponse, error) {
	...
	var response []FlashSwapOrderResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet, gateioFlashSwapOrders, params, nil, &response)
}
...
func (g *Gateio) GetSingleFlashSwapOrder(ctx context.Context, orderID string) (*FlashSwapOrderResponse, error) {
	...
	var response *FlashSwapOrderResponse
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodGet,
...
func (g *Gateio) InitiateFlashSwapOrderReview(ctx context.Context, arg FlashSwapOrderParams) (*InitFlashSwapOrderPreviewResponse, error) {
	...
	return response, g.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, spotPrivateEPL, http.MethodPost, gateioFlashSwapOrdersPreview, nil, &arg, &response)
}
...
func (g *Gateio) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (fee float64, err error) {
	...
	case goex.CryptocurrencyWithdrawalFee:

...
func (bi *Binanceus) GetSystemStatus(ctx context.Context) (int, error) {
	...
	return resp.Status, bi.SendAuthHTTPRequest(
		ctx, goex.RestSpotSupplementary,
...
func (bi *Binanceus) GetMostRecentTrades(ctx context.Context, rtr RecentTradeRequestParams) ([]RecentTrade, error) {
	...
	return resp, bi.SendHTTPRequest(ctx, goex.RestSpotSupplementary, path, spotDefaultRate, &resp)
}
...
func (bi *Binanceus) GetHistoricalTrades(ctx context.Context, hist HistoricalTradeParams) ([]HistoricalTrade, error) {
	...
	return resp, bi.SendAPIKeyHTTPRequest(ctx, goex.RestSpotSupplementary, path, spotHistoricalTradesRate, &resp)
}
...
func (bi *Binanceus) GetSinglePriceData(ctx context.Context, symbol currency.Pair) (SymbolPrice, error) {
	...
	return res, bi.SendHTTPRequest(ctx, goex.RestSpotSupplementary, path, spotDefaultRate, &res)
}
...
func (bi *Binanceus) GetPriceDatas(ctx context.Context) (SymbolPrices, error) {
	...
	return res, bi.SendHTTPRequest(ctx, goex.RestSpotSupplementary, tickerPrice, spotSymbolPriceAllRate, &res)
}
...
func (bi *Binanceus) GetBestPrice(ctx context.Context, symbol currency.Pair) (BestPrice, error) {
	...
	return resp,
		bi.SendHTTPRequest(ctx, goex.RestSpotSupplementary, path, rateLimit, &resp)
}
...
func (bi *Binanceus) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func (bi *Binanceus) getMultiplier(ctx context.Context, isMaker bool, feeBuilder *goex.FeeBuilder) (float64, error) {
...
func (bi *Binanceus) QuickEnableCryptoWithdrawal(ctx context.Context) error {
	...
	return bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary,
		http.MethodPost,
...
func (bi *Binanceus) GetUsersSpotAssetSnapshot(ctx context.Context, startTime, endTime time.Time, limit, offset uint) (*SpotAssetsSnapshotResponse, error) {
	...
	return &resp, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary,
...
func (bi *Binanceus) ExecuteSubAccountTransfer(ctx context.Context, arg *SubAccountTransferRequestParams) (*SubAccountTransferResponse, error) {
	...
	params.Set("timestamp", strconv.FormatInt(time.Now().UnixMilli(), 10))
	return &response, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodPost, subaccountTransfer, params, spotDefaultRate, &response)
}
...
func (bi *Binanceus) GetSubaccountAssets(ctx context.Context, email string) (*SubAccountAssets, error) {
	...
	//
	return &resp, bi.SendAuthHTTPRequest(ctx,
		goex.RestSpotSupplementary, http.MethodGet,
...
func (bi *Binanceus) GetMasterAccountTotalUSDValue(ctx context.Context, email string, page, size int) (*SpotUSDMasterAccounts, error) {
	...
	params.Set("timestamp", strconv.FormatInt(time.Now().UnixMilli(), 10))
	return &response, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary,
...
func (bi *Binanceus) GetOrderRateLimits(ctx context.Context, recvWindow uint) ([]OrderRateLimit, error) {
	...
	return resp, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, orderRateLimit, params, spotOrderRateLimitRate, &resp)
}
...
func (bi *Binanceus) GetMyTrades(ctx context.Context, arg *GetTradesParams) ([]Trade, error) {
	var resp []Trade
	params := url.Values{}
	...
	return resp, bi.SendAuthHTTPRequest(ctx, goex.RestSpot, http.MethodGet, myTrades, params, spotTradesQueryRate, &resp)
}
...
func (bi *Binanceus) GetOCOOrder(ctx context.Context, arg *GetOCOOrderRequestParams) (*OCOOrderResponse, error) {
	...
	return &response, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, ocoOrderList, params, spotSingleOCOOrderRate, &response)
}
...
func (bi *Binanceus) GetOpenOCOOrders(ctx context.Context, recvWindow uint) ([]OCOOrderResponse, error) {
	...
	var response []OCOOrderResponse
	return response, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet,
...
func (bi *Binanceus) GetSupportedCoinPairs(ctx context.Context, symbol currency.Pair) ([]CoinPairInfo, error) {
	...
	return resp, bi.SendAuthHTTPRequest(ctx,
		goex.RestSpotSupplementary, http.MethodGet, otcSelectors,
		params, spotDefaultRate, &resp)
}
...
func (bi *Binanceus) WithdrawFiat(ctx context.Context, arg *WithdrawFiatRequestParams) (string, error) {
	...
	var resp response
	return resp.OrderID, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary,
...
func (bi *Binanceus) GetDepositAddressForCurrency(ctx context.Context, currency, chain string) (*DepositAddress, error) {
	...
	return &d,
		bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, depositAddress, params, spotDefaultRate, &d)
}
...
func (bi *Binanceus) GetReferralRewardHistory(ctx context.Context, userBusinessType, page, rows int) (*ReferralRewardHistoryResponse, error) {
	...
	return &response, bi.SendAuthHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, referralRewardHistory, params, spotDefaultRate, &response)
}

// SendHTTPRequest sends an unauthenticated request
func (bi *Binanceus) SendHTTPRequest(ctx context.Context, ePath goex.URL, path string, f request.EndpointLimit, result interface{}) error {
...
func (bi *Binanceus) SendAPIKeyHTTPRequest(ctx context.Context, ePath goex.URL, path string, f request.EndpointLimit, result interface{}) error {
	endpointPath, err := bi.API.Endpoints.GetURL(ePath)
	if err != nil {
		return err
	}
...
func (bi *Binanceus) SendAuthHTTPRequest(ctx context.Context, ePath goex.URL, method, path string, params url.Values, f request.EndpointLimit, result interface{}) error {
	creds, err := bi.GetCredentials(ctx)
	if err != nil {
		return err
	}
...
func (bi *Binanceus) GetWsAuthStreamKey(ctx context.Context) (string, error) {
	endpointPath, err := bi.API.Endpoints.GetURL(goex.RestSpotSupplementary)
	if err != nil {
		return "", err
	}

...
func (h *HitBTC) GetCurrencies(ctx context.Context) (map[string]Currencies, error) {
	...
	err := h.SendHTTPRequest(ctx, goex.RestSpot, path, &resp.Data)
	if err != nil {
		return ret, err
	}
...
func (h *HitBTC) GetCurrency(ctx context.Context, currency string) (Currencies, error) {
	...
	return resp.Data, h.SendHTTPRequest(ctx, goex.RestSpot, path, &resp.Data)
}

// GetSymbols Return the actual list of currency symbols (currency pairs) traded
// on HitBTC goex. The first listed currency of a symbol is called the base
...
func (h *HitBTC) GetSymbolsDetailed(ctx context.Context) ([]Symbol, error) {
	...
	return resp, h.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
}
...
func (h *HitBTC) GetDepositAddresses(ctx context.Context, currency string) (DepositCryptoAddresses, error) {
	...
	return resp,
		h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
...
func (h *HitBTC) GenerateNewAddress(ctx context.Context, currency string) (DepositCryptoAddresses, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		apiV2CryptoAddress+"/"+currency,
		url.Values{},
		otherRequests,
		&resp)
...
func (h *HitBTC) GetTradeHistoryForCurrency(ctx context.Context, currency, start, end string) (AuthenticatedTradeHistoryResponse, error) {
	...
	return result, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost,
		apiV2TradeHistory,
		values,
		otherRequests,
		&result.Data)
...
func (h *HitBTC) GetOrders(ctx context.Context, currency string) ([]OrderHistoryResponse, error) {
	...
	return result, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet,
		apiV2OrderHistory,
		values,
		tradingRequests,
		&result)
...
func (h *HitBTC) CancelExistingOrder(ctx context.Context, orderID int64) (bool, error) {
	...
	err := h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete,
...
func (h *HitBTC) CancelAllExistingOrders(ctx context.Context) ([]Order, error) {
	var result []Order
	values := url.Values{}
	return result, h.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete,
		apiOrder,
		values,
		tradingRequests,
		&result)
...
func (h *HitBTC) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (h *HitBTC) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, endpoint string, values url.Values, f request.EndpointLimit, result interface{}) error {
...
func (h *HitBTC) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

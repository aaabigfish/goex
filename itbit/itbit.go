...
func (i *ItBit) GetTicker(ctx context.Context, currencyPair string) (Ticker, error) {
	...
	return response, i.SendHTTPRequest(ctx, goex.RestSpot, path, &response)
}
...
func (i *ItBit) GetWallets(ctx context.Context, params url.Values) ([]Wallet, error) {
	...
	return resp, i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, nil, &resp)
}
...
func (i *ItBit) CreateWallet(ctx context.Context, walletName string) (Wallet, error) {
	...
	err = i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, "/"+itbitWallets, params, &resp)
	if err != nil {
		return resp, err
	}
	if resp.Description != "" {
...
func (i *ItBit) GetWallet(ctx context.Context, walletID string) (Wallet, error) {
	...
	err := i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, nil, &resp)
	if err != nil {
		return resp, err
	}
	if resp.Description != "" {
...
func (i *ItBit) GetOrders(ctx context.Context, walletID, symbol, status string, page, perPage int64) ([]Order, error) {
	...
	return resp, i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, itbitOrders, params, &resp)
}
...
func (i *ItBit) PlaceOrder(ctx context.Context, walletID, side, orderType, currency string, amount, price float64, instrument, clientRef string) (Order, error) {
	...
	err := i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, path, params, &resp)
	if err != nil {
		return resp, err
	}
	if resp.Description != "" {
...
func (i *ItBit) CancelExistingOrder(ctx context.Context, walletID, orderID string) error {
	...
	return i.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, path, nil, nil)
}
...
func (i *ItBit) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (i *ItBit) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, path string, params map[string]interface{}, result interface{}) error {
	creds, err := i.GetCredentials(ctx)
	if err != nil {
		return err
	}
...
func (i *ItBit) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func getInternationalBankWithdrawalFee(c currency.Code, bankTransactionType goex.InternationalBankTransactionType) float64 {
	var fee float64
	if (bankTransactionType == goex.Swift ||
		bankTransactionType == goex.WireTransfer) &&
		c.Equal(currency.USD) {
		fee = 40
	} else if (bankTransactionType == goex.SEPA ||
		bankTransactionType == goex.WireTransfer) &&

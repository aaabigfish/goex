...
func (c *CoinbasePro) GetProducts(ctx context.Context) ([]Product, error) {
	...
	return products, c.SendHTTPRequest(ctx, goex.RestSpot, coinbaseproProducts, &products)
}
...
func (c *CoinbasePro) GetOrderbook(ctx context.Context, symbol string, level int) (interface{}, error) {
	...
	if err := c.SendHTTPRequest(ctx, goex.RestSpot, path, &orderbook); err != nil {
		return nil, err
	}
...
func (c *CoinbasePro) GetTicker(ctx context.Context, currencyPair string) (Ticker, error) {
	...
	return tick, c.SendHTTPRequest(ctx, goex.RestSpot, path, &tick)
}
...
func (c *CoinbasePro) GetTrades(ctx context.Context, currencyPair string) ([]Trade, error) {
	...
	return trades, c.SendHTTPRequest(ctx, goex.RestSpot, path, &trades)
}
...
func (c *CoinbasePro) GetHistoricRates(ctx context.Context, currencyPair, start, end string, granularity int64) ([]History, error) {
	...
	path := common.EncodeURLValues(
		...
		values)
	if err := c.SendHTTPRequest(ctx, goex.RestSpot, path, &resp); err != nil {
		return nil, err
	}
...
func (c *CoinbasePro) GetStats(ctx context.Context, currencyPair string) (Stats, error) {
	...
	return stats, c.SendHTTPRequest(ctx, goex.RestSpot, path, &stats)
}
...
func (c *CoinbasePro) GetCurrencies(ctx context.Context) ([]Currency, error) {
	...
	return currencies, c.SendHTTPRequest(ctx, goex.RestSpot, coinbaseproCurrencies, &currencies)
}
...
func (c *CoinbasePro) GetCurrentServerTime(ctx context.Context) (ServerTime, error) {
	...
	return serverTime, c.SendHTTPRequest(ctx, goex.RestSpot, coinbaseproTime, &serverTime)
}
...
func (c *CoinbasePro) GetAccounts(ctx context.Context) ([]AccountResponse, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproAccounts, nil, &resp)
}
...
func (c *CoinbasePro) GetAccount(ctx context.Context, accountID string) (AccountResponse, error) {
	...
	return resp, c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, nil, &resp)
}
...
func (c *CoinbasePro) PlaceLimitOrder(ctx context.Context, clientRef string, price, amount float64, side string, timeInforce RequestParamsTimeForceType, cancelAfter, productID, stp string, postOnly bool) (string, error) {
	...
	err := c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproOrders, req, &resp)
	if err != nil {
		return "", err
	}
...
func (c *CoinbasePro) CancelExistingOrder(ctx context.Context, orderID string) error {
	...
	return c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, path, nil, nil)
}
...
func (c *CoinbasePro) CancelAllExistingOrders(ctx context.Context, currencyPair string) ([]string, error) {
	...
	return resp, c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodDelete, coinbaseproOrders, req, &resp)
}
...
func (c *CoinbasePro) GetOrders(ctx context.Context, status []string, currencyPair string) ([]GeneralizedOrderResponse, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, path, nil, &resp)
}
...
func (c *CoinbasePro) MarginTransfer(ctx context.Context, amount float64, transferType, profileID, currency string) (MarginTransfer, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproMarginTransfer, req, &resp)
}
...
func (c *CoinbasePro) GetPosition(ctx context.Context) (AccountOverview, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproPosition, nil, &resp)
}
...
func (c *CoinbasePro) ClosePosition(ctx context.Context, repayOnly bool) (AccountOverview, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproPositionClose, req, &resp)
}
...
func (c *CoinbasePro) GetPayMethods(ctx context.Context) ([]PaymentMethod, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproPaymentMethod, nil, &resp)
}
...
func (c *CoinbasePro) DepositViaPaymentMethod(ctx context.Context, amount float64, currency, paymentID string) (DepositWithdrawalInfo, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproPaymentMethodDeposit, req, &resp)
}
...
func (c *CoinbasePro) DepositViaCoinbase(ctx context.Context, amount float64, currency, accountID string) (DepositWithdrawalInfo, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproDepositCoinbase, req, &resp)
}
...
func (c *CoinbasePro) WithdrawViaPaymentMethod(ctx context.Context, amount float64, currency, paymentID string) (DepositWithdrawalInfo, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproWithdrawalPaymentMethod, req, &resp)
}
...
func (c *CoinbasePro) WithdrawCrypto(ctx context.Context, amount float64, currency, cryptoAddress string) (DepositWithdrawalInfo, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproWithdrawalCrypto, req, &resp)
}
...
func (c *CoinbasePro) GetCoinbaseAccounts(ctx context.Context) ([]CoinbaseAccounts, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproCoinbaseAccounts, nil, &resp)
}
...
func (c *CoinbasePro) GetReport(ctx context.Context, reportType, startDate, endDate, currencyPair, accountID, format, email string) (Report, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodPost, coinbaseproReports, req, &resp)
}
...
func (c *CoinbasePro) GetTrailingVolume(ctx context.Context) ([]Volume, error) {
	...
	return resp,
		c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproTrailingVolume, nil, &resp)
}
...
func (c *CoinbasePro) GetTransfers(ctx context.Context, profileID, transferType string, limit int64, start, end time.Time) ([]TransferHistory, error) {
	...
	return resp, c.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, http.MethodGet, coinbaseproTransfers, req, &resp)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (c *CoinbasePro) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (c *CoinbasePro) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, method, path string, params map[string]interface{}, result interface{}) (err error) {
...
func (c *CoinbasePro) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

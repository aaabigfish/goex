...
func (b *Bithumb) GetTicker(ctx context.Context, symbol string) (Ticker, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, publicTicker+strings.ToUpper(symbol), &response)
	if err != nil {
...
func (b *Bithumb) GetAllTickers(ctx context.Context) (map[string]Ticker, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, publicTicker+"all", &response)
	if err != nil {
		return nil, err
	}
...
func (b *Bithumb) GetOrderBook(ctx context.Context, symbol string) (*Orderbook, error) {
	response := Orderbook{}
	err := b.SendHTTPRequest(ctx, goex.RestSpot, publicOrderBook+strings.ToUpper(symbol), &response)
	if err != nil {
		return nil, err
	}
...
func (b *Bithumb) GetAssetStatus(ctx context.Context, symbol string) (*Status, error) {
	...
	var response Status
	err := b.SendHTTPRequest(ctx, goex.RestSpot, publicAssetStatus+strings.ToUpper(symbol), &response)
	if err != nil {
		return nil, err
	}
...
func (b *Bithumb) GetAssetStatusAll(ctx context.Context) (*StatusAll, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, publicAssetStatus+"ALL", &response)
	if err != nil {
		return nil, err
	}
...
func (b *Bithumb) GetTransactionHistory(ctx context.Context, symbol string) (TransactionHistory, error) {
	...
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &response)
	if err != nil {
		return response, err
	}
...
func (b *Bithumb) GetAccountInformation(ctx context.Context, orderCurrency, paymentCurrency string) (Account, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateAccInfo, val, &response)
}
...
func (b *Bithumb) GetAccountBalance(ctx context.Context, c string) (FullBalance, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateAccBalance, vals, &response)
	if err != nil {
...
func (b *Bithumb) GetWalletAddress(ctx context.Context, curr currency.Code) (WalletAddressRes, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateWalletAdd, params, &response)
	if err != nil {
		return response, err
	}
...
func (b *Bithumb) GetLastTransaction(ctx context.Context) (LastTransactionTicker, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateTicker, nil, &response)
}
...
func (b *Bithumb) GetOrders(ctx context.Context, orderID, transactionType string, count int64, after time.Time, orderCurrency, paymentCurrency currency.Code) (Orders, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateOrders, params, &response)
}
...
func (b *Bithumb) GetUserTransactions(ctx context.Context, offset, count, searchType int64, orderCurrency, paymentCurrency currency.Code) (UserTransactions, error) {
	...
	return response, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateUserTrans, params, &response)
}
...
func (b *Bithumb) PlaceTrade(ctx context.Context, orderCurrency, transactionType string, units float64, price int64) (OrderPlace, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privatePlaceTrade, params, &response)
}
...
func (b *Bithumb) GetOrderDetails(ctx context.Context, orderID, transactionType, currency string) (OrderDetails, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateOrderDetail, params, &response)
}
...
func (b *Bithumb) CancelTrade(ctx context.Context, transactionType, orderID, currency string) (ActionStatus, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateCancelTrade, nil, &response)
}
...
func (b *Bithumb) WithdrawCrypto(ctx context.Context, address, destination, currency string, units float64) (ActionStatus, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateBTCWithdraw, params, &response)
}
...
func (b *Bithumb) RequestKRWDepositDetails(ctx context.Context) (KRWDeposit, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateKRWDeposit, nil, &response)
}
...
func (b *Bithumb) RequestKRWWithdraw(ctx context.Context, bank, account string, price int64) (ActionStatus, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateKRWWithdraw, params, &response)
}
...
func (b *Bithumb) MarketBuyOrder(ctx context.Context, pair currency.Pair, units float64) (MarketBuy, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateMarketBuy, params, &response)
}
...
func (b *Bithumb) MarketSellOrder(ctx context.Context, pair currency.Pair, units float64) (MarketSell, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, privateMarketSell, params, &response)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (b *Bithumb) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (b *Bithumb) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, path string, params url.Values, result interface{}) error {
...
func (b *Bithumb) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64

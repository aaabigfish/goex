...
func (b *Bitstamp) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func (b *Bitstamp) getTradingFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
...
func (b *Bitstamp) GetAccountTradingFee(ctx context.Context, pair currency.Pair) (TradingFees, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, path, true, nil, &resp)
...
func (b *Bitstamp) GetTicker(ctx context.Context, currency string, hourly bool) (*Ticker, error) {
	...
	return &response, b.SendHTTPRequest(ctx, goex.RestSpot, path, &response)
}
...
func (b *Bitstamp) GetOrderbook(ctx context.Context, currency string) (*Orderbook, error) {
	...
	var resp response
	err := b.SendHTTPRequest(ctx, goex.RestSpot, path, &resp)
	if err != nil {
		return nil, err
	}
...
func (b *Bitstamp) GetTradingPairs(ctx context.Context) ([]TradingPair, error) {
	...
	return result, b.SendHTTPRequest(ctx, goex.RestSpot, path, &result)
}
...
func (b *Bitstamp) GetTransactions(ctx context.Context, currencyPair, timePeriod string) ([]Transactions, error) {
	...
	return transactions, b.SendHTTPRequest(ctx, goex.RestSpot, requestURL, &transactions)
}
...
func (b *Bitstamp) GetEURUSDConversionRate(ctx context.Context) (EURUSDConversionRate, error) {
	...
	return rate, b.SendHTTPRequest(ctx, goex.RestSpot, path, &rate)
}

// GetBalance returns full balance of currency held on the exchange
func (b *Bitstamp) GetBalance(ctx context.Context) (Balances, error) {
	var balance map[string]string
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIBalance, true, nil, &balance)
	if err != nil {
		return nil, err
	}
	currs := []string{}
...
func (b *Bitstamp) GetUserTransactions(ctx context.Context, currencyPair string) ([]UserTransactions, error) {
	...
	if currencyPair == "" {
		if err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIUserTransactions,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
		...
		if err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIUserTransactions+"/"+currencyPair,
			true,
			url.Values{},
			&response); err != nil {
			return nil, err
...
func (b *Bitstamp) GetOpenOrders(ctx context.Context, currencyPair string) ([]Order, error) {
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, path, true, nil, &resp)
}
...
func (b *Bitstamp) GetOrderStatus(ctx context.Context, orderID int64) (OrderStatus, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIOrderStatus, false, req, &resp)
}
...
func (b *Bitstamp) CancelExistingOrder(ctx context.Context, orderID int64) (CancelOrder, error) {
	...
	err := b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPICancelOrder, true, req, &result)
	if err != nil {
		return result, err
	}
...
func (b *Bitstamp) CancelAllExistingOrders(ctx context.Context) (bool, error) {
	...
	return result,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPICancelAllOrders, false, nil, &result)
}

// PlaceOrder places an order on the goex.
func (b *Bitstamp) PlaceOrder(ctx context.Context, currencyPair string, price, amount float64, buy, market bool) (Order, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, path, true, req, &response)
}
...
func (b *Bitstamp) GetWithdrawalRequests(ctx context.Context, timedelta int64) ([]WithdrawalRequests, error) {
	...
	return resp,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIWithdrawalRequests, false, value, &resp)
}
...
func (b *Bitstamp) CryptoWithdrawal(ctx context.Context, amount float64, address, symbol, destTag string) (*CryptoWithdrawalResponse, error) {
	...
	return &resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, endpoint, true, req, &resp)
}
...
func (b *Bitstamp) OpenBankWithdrawal(ctx context.Context, amount float64, currency,
	...
	return resp, b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIOpenWithdrawal, true, req, &resp)
}
...
func (b *Bitstamp) GetUnconfirmedBitcoinDeposits(ctx context.Context) ([]UnconfirmedBTCTransactions, error) {
	...
	return response,
		b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, bitstampAPIUnconfirmedBitcoin, false, nil, &response)
}
...
func (b *Bitstamp) OHLC(ctx context.Context, currency string, start, end time.Time, step, limit string) (resp OHLCResponse, err error) {
	...
	return resp, b.SendHTTPRequest(ctx, goex.RestSpot, common.EncodeURLValues("/v"+bitstampAPIVersion+"/"+bitstampAPIOHLC+"/"+currency, v), &resp)
}
...
func (b *Bitstamp) TransferAccountBalance(ctx context.Context, amount float64, currency, subAccount string, toMain bool) error {
	...
	return b.SendAuthenticatedHTTPRequest(ctx, goex.RestSpot, path, true, req, &resp)
}

// SendHTTPRequest sends an unauthenticated HTTP request
func (b *Bitstamp) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}) error {
...
func (b *Bitstamp) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, path string, v2 bool, values url.Values, result interface{}) error {

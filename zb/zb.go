...
func (z *ZB) SpotNewOrder(ctx context.Context, arg SpotNewOrderRequestParams) (int64, error) {
	...
	err = z.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, vals, &result, request.Auth)
	if err != nil {
		return 0, err
	}
	if result.Code != 1000 {
...
func (z *ZB) GetDepositRecords(ctx context.Context, arg *WalletRecordsRequest) (*DepositRecordsResponse, error) {
	...
	return &resp, z.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, vals, &resp, request.Auth)
}
...
func (z *ZB) GetAccountInformation(ctx context.Context) (AccountsResponse, error) {
	...
	return result, z.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, vals, &result, request.Auth)
}
...
func (z *ZB) GetOrders(ctx context.Context, currency string, pageindex, side int64) ([]Order, error) {
	...
	return response, z.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, vals, &response, request.Auth)
}
...
func (z *ZB) GetMarkets(ctx context.Context) (map[string]MarketResponseItem, error) {
	...
	err := z.SendHTTPRequest(ctx, goex.RestSpot, endpoint, &res, request.UnAuth)
	if err != nil {
		return nil, err
	}
...
func (z *ZB) GetTicker(ctx context.Context, symbol string) (TickerResponse, error) {
	...
	err := z.SendHTTPRequest(ctx, goex.RestSpot, urlPath, &res, request.UnAuth)
	return res, err
}
...
func (z *ZB) GetTickers(ctx context.Context) (map[string]TickerChildResponse, error) {
	...
	err := z.SendHTTPRequest(ctx, goex.RestSpot, urlPath, &resp, request.UnAuth)
	return resp, err
}
...
func (z *ZB) GetSpotKline(ctx context.Context, arg KlinesRequestParams) (KLineResponse, error) {
	...
	err := z.SendHTTPRequest(ctx, goex.RestSpot, urlPath, &resp, klineFunc)
	if err != nil {
		return res, err
	}
...
func (z *ZB) SendHTTPRequest(ctx context.Context, ep goex.URL, path string, result interface{}, f request.EndpointLimit) error {
...
func (z *ZB) SendAuthenticatedHTTPRequest(ctx context.Context, ep goex.URL, httpMethod string, params url.Values, result interface{}, f request.EndpointLimit) error {
	creds, err := z.GetCredentials(ctx)
	if err != nil {
		return err
	}
...
func (z *ZB) GetFee(feeBuilder *goex.FeeBuilder) (float64, error) {
	var fee float64
...
func (z *ZB) Withdraw(ctx context.Context, currency, address, safepassword string, amount, fees float64, itransfer bool) (string, error) {
	...
	var resp response
	err = z.SendAuthenticatedHTTPRequest(ctx, goex.RestSpotSupplementary, http.MethodGet, vals, &resp, request.Auth)
	if err != nil {
		return "", err
	}
	if resp.Code != 1000 {

...
func TestWithdrawal(t *testing.T) {
	...
	_, err := ok.Withdrawal(contextGenerate(), &WithdrawalInput{Amount: 0.1, TransactionFee: 0.00005, Currency: "BTC", WithdrawalDestination: "4", ToAddress: common.BitcoinDonationAddress})
	if err != nil {
...
func TestGetFeeByType(t *testing.T) {
	...
	if _, err := ok.GetFeeByType(contextGenerate(), &goex.FeeBuilder{
		Amount:  1,

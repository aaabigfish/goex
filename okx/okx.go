...
func (ok *Okx) PlaceOrder(ctx context.Context, arg *PlaceOrderRequestParam, a asset.Item) (*OrderData, error) {
	...
	var resp []OrderData
	err = ok.SendHTTPRequest(ctx, goex.RestSpot, placeOrderEPL, http.MethodPost, tradeOrder, &arg, &resp, true)
	if err != nil {
		if len(resp) != 1 {
			return nil, err
		}
...
func (ok *Okx) PlaceMultipleOrders(ctx context.Context, args []PlaceOrderRequestParam) ([]OrderData, error) {
	...
	var resp []OrderData
	err = ok.SendHTTPRequest(ctx, goex.RestSpot, placeMultipleOrdersEPL, http.MethodPost, placeMultipleOrderURL, &args, &resp, true)
	if err != nil {
		if len(resp) == 0 {
			return nil, err
		}
...
func (ok *Okx) CancelSingleOrder(ctx context.Context, arg CancelOrderRequestParam) (*OrderData, error) {
	...
	var resp []OrderData
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelOrderEPL, http.MethodPost, cancelTradeOrder, &arg, &resp, true)
	if err != nil {
		if len(resp) != 1 {
			return nil, err
		}
...
func (ok *Okx) CancelMultipleOrders(ctx context.Context, args []CancelOrderRequestParam) ([]OrderData, error) {
	...
	var resp []OrderData
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelMultipleOrdersEPL,
...
func (ok *Okx) AmendOrder(ctx context.Context, arg *AmendOrderRequestParams) (*OrderData, error) {
	...
	var resp []OrderData
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, amendOrderEPL, http.MethodPost, amendOrder, arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) AmendMultipleOrders(ctx context.Context, args []AmendOrderRequestParams) ([]OrderData, error) {
	...
	var resp []OrderData
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, amendMultipleOrdersEPL, http.MethodPost, amendBatchOrders, &args, &resp, true)
}
...
func (ok *Okx) ClosePositions(ctx context.Context, arg *ClosePositionsRequestParams) (*ClosePositionResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, closePositionEPL, http.MethodPost, closePositionPath, arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetOrderDetail(ctx context.Context, arg *OrderDetailRequestParam) (*OrderDetail, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOrderDetEPL, http.MethodGet, common.EncodeURLValues(tradeOrder, params), nil, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetOrderList(ctx context.Context, arg *OrderListRequestParams) ([]OrderDetail, error) {
	...
	var resp []OrderDetail
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getOrderListEPL, http.MethodGet, common.EncodeURLValues(pendingTradeOrders, params), nil, &resp, true)
}
...
func (ok *Okx) getOrderHistory(ctx context.Context, arg *OrderHistoryRequestParams, route string, rateLimit request.EndpointLimit) ([]OrderDetail, error) {
	...
	var resp []OrderDetail
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, rateLimit, http.MethodGet, common.EncodeURLValues(route, params), nil, &resp, true)
}
...
func (ok *Okx) PlaceAlgoOrder(ctx context.Context, arg *AlgoOrderParams) (*AlgoOrder, error) {
	...
	var resp []AlgoOrder
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, placeAlgoOrderEPL, http.MethodGet, algoTradeOrder, arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) cancelAlgoOrder(ctx context.Context, args []AlgoOrderCancelParams, route string, rateLimit request.EndpointLimit) ([]AlgoOrder, error) {
	...
	resp := []AlgoOrder{}
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, rateLimit, http.MethodPost, route, &args, &resp, true)
}
...
func (ok *Okx) GetAlgoOrderList(ctx context.Context, orderType, algoOrderID, clientOrderID, instrumentType, instrumentID string, after, before time.Time, limit int64) ([]AlgoOrderResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAlgoOrderListEPL, http.MethodGet, common.EncodeURLValues(getAlgoOrders, params), nil, &resp, true)
}
...
func (ok *Okx) GetAlgoOrderHistory(ctx context.Context, orderType, state, algoOrderID, instrumentType, instrumentID string, after, before time.Time, limit int64) ([]AlgoOrderResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAlgoOrderHistoryEPL, http.MethodGet, common.EncodeURLValues(algoOrderHistory, params), nil, &resp, true)
}
...
func (ok *Okx) GetEasyConvertCurrencyList(ctx context.Context) (*EasyConvertDetail, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getEasyConvertCurrencyListEPL, http.MethodGet,
...
func (ok *Okx) PlaceEasyConvert(ctx context.Context, arg PlaceEasyConvertParam) ([]EasyConvertItem, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, placeEasyConvertEPL, http.MethodPost, easyConvert, &arg, &resp, true)
}
...
func (ok *Okx) GetEasyConvertHistory(ctx context.Context, after, before time.Time, limit int64) ([]EasyConvertItem, error) {
	...
	var resp []EasyConvertItem
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getEasyConvertHistoryEPL, http.MethodGet, easyConvertHistoryPath, nil, &resp, true)
}
...
func (ok *Okx) GetOneClickRepayCurrencyList(ctx context.Context, debtType string) ([]CurrencyOneClickRepay, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, oneClickRepayCurrencyListEPL, http.MethodGet, common.EncodeURLValues(oneClickRepayCurrencyListPath, params), nil, &resp, true)
}
...
func (ok *Okx) TradeOneClickRepay(ctx context.Context, arg TradeOneClickRepayParam) ([]CurrencyOneClickRepay, error) {
	...
	var resp []CurrencyOneClickRepay
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, tradeOneClickRepayEPL, http.MethodPost, oneClickRepay, &arg, &resp, true)
}
...
func (ok *Okx) GetOneClickRepayHistory(ctx context.Context, after, before time.Time, limit int64) ([]CurrencyOneClickRepay, error) {
	...
	var resp []CurrencyOneClickRepay
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getOneClickRepayHistoryEPL, http.MethodGet, common.EncodeURLValues(oneClickRepayHistory, params), nil, &resp, true)
}
...
func (ok *Okx) GetCounterparties(ctx context.Context) ([]CounterpartiesResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getCounterpartiesEPL, http.MethodGet, rfqCounterparties, nil, &resp, true)
}
...
func (ok *Okx) CreateRfq(ctx context.Context, arg CreateRfqInput) (*RfqResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, createRfqEPL, http.MethodPost, rfqCreateRfq, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) CancelRfq(ctx context.Context, arg CancelRfqRequestParam) (*CancelRfqResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelRfqEPL, http.MethodPost, rfqCancelRfq, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) CancelMultipleRfqs(ctx context.Context, arg CancelRfqRequestsParam) ([]CancelRfqResponse, error) {
	...
	var resp []CancelRfqResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, cancelMultipleRfqEPL, http.MethodPost, rfqCancelRfqs, &arg, &resp, true)
}
...
func (ok *Okx) CancelAllRfqs(ctx context.Context) (time.Time, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelAllRfqsEPL, http.MethodPost, rfqCancelAllRfqs, nil, &resp, true)
	if err != nil {
...
func (ok *Okx) ExecuteQuote(ctx context.Context, arg ExecuteQuoteParams) (*ExecuteQuoteResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, executeQuoteEPL, http.MethodPost, rfqExecuteQuote, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) SetQuoteProducts(ctx context.Context, args []SetQuoteProductParam) (*SetQuoteProductsResult, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, setQuoteProductsEPL, http.MethodPost, makerInstrumentSettings, &args, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) ResetMMPStatus(ctx context.Context) (time.Time, error) {
	var resp []TimestampResponse
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, restMMPStatusEPL, http.MethodPost, mmpReset, nil, &resp, true); err != nil {
		return time.Time{}, err
	}
	if len(resp) == 1 {
		return resp[0].Timestamp.Time(), nil
...
func (ok *Okx) CreateQuote(ctx context.Context, arg CreateQuoteParams) (*QuoteResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, createQuoteEPL, http.MethodPost, rfqCreateQuote, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) CancelQuote(ctx context.Context, arg CancelQuoteRequestParams) (*CancelQuoteResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelQuoteEPL, http.MethodPost, rfqCancelQuote, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) CancelMultipleQuote(ctx context.Context, arg CancelQuotesRequestParams) ([]CancelQuoteResponse, error) {
	...
	var resp []CancelQuoteResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, cancelMultipleQuotesEPL, http.MethodPost, rfqCancelBatchQuotes, &arg, &resp, true)
}

// CancelAllQuotes cancels all active Quotes.
func (ok *Okx) CancelAllQuotes(ctx context.Context) (time.Time, error) {
	var resp []TimestampResponse
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelAllQuotesEPL, http.MethodPost, rfqCancelAllQuotes, nil, &resp, true)
	if err != nil {
		return time.Time{}, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetRfqs(ctx context.Context, arg *RfqRequestParams) ([]RfqResponse, error) {
	...
	var resp []RfqResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getRfqsEPL, http.MethodGet, common.EncodeURLValues(rfqRfqs, params), nil, &resp, true)
}
...
func (ok *Okx) GetQuotes(ctx context.Context, arg *QuoteRequestParams) ([]QuoteResponse, error) {
	...
	var resp []QuoteResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getQuotesEPL, http.MethodGet, common.EncodeURLValues(rfqQuotes, params), nil, &resp, true)
}
...
func (ok *Okx) GetRfqTrades(ctx context.Context, arg *RfqTradesRequestParams) ([]RfqTradeResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getTradesEPL, http.MethodGet, common.EncodeURLValues(rfqTrades, params), nil, &resp, true)
}
...
func (ok *Okx) GetPublicTrades(ctx context.Context, beginID, endID string, limit int64) ([]PublicTradesResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPublicTradesEPL, http.MethodGet, common.EncodeURLValues(rfqPublicTrades, params), nil, &resp, true)
}
...
func (ok *Okx) GetFundingCurrencies(ctx context.Context) ([]CurrencyResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getCurrenciesEPL, http.MethodGet, assetCurrencies, nil, &resp, true)
}
...
func (ok *Okx) GetBalance(ctx context.Context, currency string) ([]AssetBalance, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBalanceEPL, http.MethodGet, common.EncodeURLValues(assetBalance, params), nil, &resp, true)
}
...
func (ok *Okx) GetAccountAssetValuation(ctx context.Context, currency string) ([]AccountAssetValuation, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAccountAssetValuationEPL, http.MethodGet, common.EncodeURLValues(assetValuation, params), nil, &resp, true)
}
...
func (ok *Okx) FundingTransfer(ctx context.Context, arg *FundingTransferRequestInput) ([]FundingTransferResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, fundsTransferEPL, http.MethodPost, assetTransfer, arg, &resp, true)
}
...
func (ok *Okx) GetFundsTransferState(ctx context.Context, transferID, clientID string, transferType int64) ([]TransferFundRateResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getFundsTransferStateEPL, http.MethodGet, common.EncodeURLValues(assetTransferState, params), nil, &resp, true)
}
...
func (ok *Okx) GetAssetBillsDetails(ctx context.Context, currency, clientID string, after, before time.Time, billType, limit int64) ([]AssetBillDetail, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, assetBillsDetailsEPL, http.MethodGet, common.EncodeURLValues(assetBills, params), nil, &resp, true)
}
...
func (ok *Okx) GetLightningDeposits(ctx context.Context, currency string, amount float64, to int64) ([]LightningDepositItem, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, lightningDepositsEPL, http.MethodGet, common.EncodeURLValues(lightningDeposit, params), nil, &resp, true)
}
...
func (ok *Okx) GetCurrencyDepositAddress(ctx context.Context, currency string) ([]CurrencyDepositResponseItem, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getDepositAddressEPL, http.MethodGet, common.EncodeURLValues(assetDeposits, params), nil, &resp, true)
}
...
func (ok *Okx) GetCurrencyDepositHistory(ctx context.Context, currency, depositID, transactionID string, after, before time.Time, state, limit int64) ([]DepositHistoryResponseItem, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getDepositHistoryEPL, http.MethodGet, common.EncodeURLValues(pathToAssetDepositHistory, params), nil, &resp, true)
}
...
func (ok *Okx) Withdrawal(ctx context.Context, input *WithdrawalInput) (*WithdrawalResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, withdrawalEPL, http.MethodPost, assetWithdrawal, &input, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) LightningWithdrawal(ctx context.Context, arg LightningWithdrawalRequestInput) (*LightningWithdrawalResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, lightningWithdrawalsEPL, http.MethodPost, assetLightningWithdrawal, &arg, &resp, true)
	if err != nil {
		return nil, err
	} else if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) CancelWithdrawal(ctx context.Context, withdrawalID string) (string, error) {
	...
	return response.WithdrawalID, ok.SendHTTPRequest(ctx, goex.RestSpot, cancelWithdrawalEPL, http.MethodPost, cancelWithdrawal, request, &response, true)
}
...
func (ok *Okx) GetWithdrawalHistory(ctx context.Context, currency, withdrawalID, clientID, transactionID, state string, after, before time.Time, limit int64) ([]WithdrawalHistoryResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getWithdrawalHistoryEPL, http.MethodGet, common.EncodeURLValues(withdrawalHistory, params), nil, &resp, true)
}
...
func (ok *Okx) SmallAssetsConvert(ctx context.Context, currency []string) (*SmallAssetConvertResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, smallAssetsConvertEPL, http.MethodPost, smallAssetsConvert, input, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetSavingBalance(ctx context.Context, currency string) ([]SavingBalanceResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getSavingBalanceEPL, http.MethodGet, common.EncodeURLValues(financeSavingBalance, params), nil, &resp, true)
}
...
func (ok *Okx) SavingsPurchaseOrRedemption(ctx context.Context, arg *SavingsPurchaseRedemptionInput) (*SavingsPurchaseRedemptionResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, savingsPurchaseRedemptionEPL, http.MethodPost, financePurchaseRedempt, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetLendingHistory(ctx context.Context, currency string, before, after time.Time, limit int64) ([]LendingHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getLendingHistoryEPL, http.MethodGet, common.EncodeURLValues(financeLendingHistory, params), nil, &resp, true)
}
...
func (ok *Okx) SetLendingRate(ctx context.Context, arg LendingRate) (*LendingRate, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, setLendingRateEPL, http.MethodPost, financeSetLendingRate, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetPublicBorrowInfo(ctx context.Context, currency string) ([]PublicBorrowInfo, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPublicBorrowInfoEPL, http.MethodGet, common.EncodeURLValues(financePublicBorrowInfo, params), nil, &resp, false)
}
...
func (ok *Okx) GetPublicBorrowHistory(ctx context.Context, currency string, before, after time.Time, limit int64) ([]PublicBorrowHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPublicBorrowHistoryEPL, http.MethodGet, common.EncodeURLValues(financePublicBorrowHistory, params), nil, &resp, false)
}
...
func (ok *Okx) GetConvertCurrencies(ctx context.Context) ([]ConvertCurrency, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getConvertCurrenciesEPL, http.MethodGet, assetConvertCurrencies, nil, &resp, true)
}
...
func (ok *Okx) GetConvertCurrencyPair(ctx context.Context, fromCurrency, toCurrency string) (*ConvertCurrencyPair, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getConvertCurrencyPairEPL, http.MethodGet, common.EncodeURLValues(convertCurrencyPairsPath, params), nil, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) EstimateQuote(ctx context.Context, arg *EstimateQuoteRequestInput) (*EstimateQuoteResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, estimateQuoteEPL, http.MethodPost, assetEstimateQuote, arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) ConvertTrade(ctx context.Context, arg *ConvertTradeInput) (*ConvertTradeResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, convertTradeEPL, http.MethodPost, assetConvertTrade, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetConvertHistory(ctx context.Context, before, after time.Time, limit int64, tag string) ([]ConvertHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getConvertHistoryEPL, http.MethodGet, common.EncodeURLValues(assetConvertHistory, params), nil, &resp, true)
}
...
func (ok *Okx) AccountBalance(ctx context.Context, currency string) ([]Account, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAccountBalanceEPL, http.MethodGet, common.EncodeURLValues(accountBalance, params), nil, &resp, true)
}
...
func (ok *Okx) GetPositions(ctx context.Context, instrumentType, instrumentID, positionID string) ([]AccountPosition, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPositionsEPL, http.MethodGet, common.EncodeURLValues(accountPosition, params), nil, &resp, true)
}
...
func (ok *Okx) GetPositionsHistory(ctx context.Context, instrumentType, instrumentID, marginMode string, closePositionType, limit int64, after, before time.Time) ([]AccountPositionHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPositionsHistoryEPL, http.MethodGet, common.EncodeURLValues(accountPositionHistory, params), nil, &resp, true)
}
...
func (ok *Okx) GetAccountAndPositionRisk(ctx context.Context, instrumentType string) ([]AccountAndPositionRisk, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAccountAndPositionRiskEPL, http.MethodGet, common.EncodeURLValues(accountAndPositionRisk, params), nil, &resp, true)
}
...
func (ok *Okx) GetBillsDetail(ctx context.Context, arg *BillsDetailQueryParameter, route string) ([]BillsDetailResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBillsDetailsEPL, http.MethodGet, common.EncodeURLValues(route, params), nil, &resp, true)
}
...
func (ok *Okx) GetAccountConfiguration(ctx context.Context) ([]AccountConfigurationResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAccountConfigurationEPL, http.MethodGet, accountConfiguration, nil, &resp, true)
}
...
func (ok *Okx) SetPositionMode(ctx context.Context, positionMode string) (string, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, setPositionModeEPL, http.MethodPost, accountSetPositionMode, input, &resp, true)
	if err != nil {
		return "", err
	}
	if len(resp) == 1 {
...
func (ok *Okx) SetLeverageRate(ctx context.Context, arg SetLeverageInput) (*SetLeverageResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, setLeverageEPL, http.MethodPost, accountSetLeverage, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetMaximumBuySellAmountOROpenAmount(ctx context.Context, instrumentID, tradeMode, currency, leverage string, price float64) ([]MaximumBuyAndSell, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getMaximumBuyOrSellAmountEPL, http.MethodGet, common.EncodeURLValues(accountMaxSize, params), nil, &resp, true)
}
...
func (ok *Okx) GetMaximumAvailableTradableAmount(ctx context.Context, instrumentID, currency, tradeMode string, reduceOnly bool, price float64) ([]MaximumTradableAmount, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getMaximumAvailableTradableAmountEPL, http.MethodGet, common.EncodeURLValues(accountMaxAvailSize, params), nil, &resp, true)
}
...
func (ok *Okx) IncreaseDecreaseMargin(ctx context.Context, arg IncreaseDecreaseMarginInput) (*IncreaseDecreaseMargin, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, increaseOrDecreaseMarginEPL, http.MethodPost, accountPositionMarginBalance, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetLeverageRate(ctx context.Context, instrumentID, marginMode string) ([]LeverageResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getLeverageEPL, http.MethodGet, common.EncodeURLValues(accountLeverageInfo, params), nil, &resp, true)
}
...
func (ok *Okx) GetMaximumLoanOfInstrument(ctx context.Context, instrumentID, marginMode, mgnCurrency string) ([]MaximumLoanInstrument, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getTheMaximumLoanOfInstrumentEPL, http.MethodGet, common.EncodeURLValues(accountMaxLoan, params), nil, &resp, true)
}

// GetFee returns Cryptocurrency trade fee, and offline trade fee
func (ok *Okx) GetFee(ctx context.Context, feeBuilder *goex.FeeBuilder) (float64, error) {
	// Here the Asset Type for the instrument Type is needed for getting the CryptocurrencyTrading Fee.
	var fee float64
	switch feeBuilder.FeeType {
	case goex.CryptocurrencyTradeFee:
...
func (ok *Okx) GetTradeFee(ctx context.Context, instrumentType, instrumentID, underlying string) ([]TradeFeeRate, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getFeeRatesEPL, http.MethodGet, common.EncodeURLValues(accountTradeFee, params), nil, &resp, true)
}
...
func (ok *Okx) GetInterestAccruedData(ctx context.Context, loanType, limit int64, currency, instrumentID, marginMode string, after, before time.Time) ([]InterestAccruedData, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getInterestAccruedDataEPL, http.MethodGet, common.EncodeURLValues(accountInterestAccrued, params), nil, &resp, true)
}
...
func (ok *Okx) GetInterestRate(ctx context.Context, currency string) ([]InterestRateResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getInterestRateEPL, http.MethodGet, common.EncodeURLValues(accountInterestRate, params), nil, &resp, true)
}
...
func (ok *Okx) SetGreeks(ctx context.Context, greeksType string) (*GreeksType, error) {
	...
	var resp []GreeksType
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, setGreeksEPL, http.MethodPost, accountSetGreeks, input, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) IsolatedMarginTradingSettings(ctx context.Context, arg IsolatedMode) (*IsolatedMode, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, isolatedMarginTradingSettingsEPL, http.MethodPost, accountSetIsolatedMode, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetMaximumWithdrawals(ctx context.Context, currency string) ([]MaximumWithdrawal, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getMaximumWithdrawalsEPL, http.MethodGet, common.EncodeURLValues(accountMaxWithdrawal, params), nil, &resp, true)
}
...
func (ok *Okx) GetAccountRiskState(ctx context.Context) ([]AccountRiskState, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getAccountRiskStateEPL, http.MethodGet, accountRiskState, nil, &resp, true)
}
...
func (ok *Okx) VIPLoansBorrowAndRepay(ctx context.Context, arg LoanBorrowAndReplayInput) (*LoanBorrowAndReplay, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, vipLoansBorrowAnsRepayEPL, http.MethodPost, accountBorrowReply, &arg, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetBorrowAndRepayHistoryForVIPLoans(ctx context.Context, currency string, after, before time.Time, limit int64) ([]BorrowRepayHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBorrowAnsRepayHistoryHistoryEPL, http.MethodGet, common.EncodeURLValues(accountBorrowRepayHistory, params), nil, &resp, true)
}
...
func (ok *Okx) GetBorrowInterestAndLimit(ctx context.Context, loanType int64, currency string) ([]BorrowInterestAndLimitResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBorrowInterestAndLimitEPL, http.MethodGet, common.EncodeURLValues(accountInterestLimits, params), nil, &resp, true)
}
...
func (ok *Okx) PositionBuilder(ctx context.Context, arg PositionBuilderInput) ([]PositionBuilderResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, positionBuilderEPL, http.MethodPost, accountSimulatedMargin, &arg, &resp, true)
}
...
func (ok *Okx) GetGreeks(ctx context.Context, currency string) ([]GreeksItem, error) {
	...
	var resp []GreeksItem
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getGreeksEPL, http.MethodGet, common.EncodeURLValues(accountGreeks, params), nil, &resp, true)
}
...
func (ok *Okx) GetPMLimitation(ctx context.Context, instrumentType, underlying string) ([]PMLimitationResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getPMLimitationEPL, http.MethodGet, common.EncodeURLValues(accountPortfolioMarginLimitation, params), nil, &resp, true)
}
...
func (ok *Okx) ViewSubAccountList(ctx context.Context, enable bool, subaccountName string, after, before time.Time, limit int64) ([]SubaccountInfo, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, viewSubaccountListEPL, http.MethodGet, common.EncodeURLValues(usersSubaccountList, params), nil, &resp, true)
}
...
func (ok *Okx) ResetSubAccountAPIKey(ctx context.Context, arg *SubAccountAPIKeyParam) (*SubAccountAPIKeyResponse, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, resetSubAccountAPIKeyEPL, http.MethodPost, subAccountModifyAPIKey, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetSubaccountTradingBalance(ctx context.Context, subaccountName string) ([]SubaccountBalanceResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getSubaccountTradingBalanceEPL, http.MethodGet, common.EncodeURLValues(accountSubaccountBalances, params), nil, &resp, true)
}
...
func (ok *Okx) GetSubaccountFundingBalance(ctx context.Context, subaccountName, currency string) ([]FundingBalance, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getSubaccountFundingBalanceEPL, http.MethodGet, common.EncodeURLValues(assetSubaccountBalances, params), nil, &resp, true)
}
...
func (ok *Okx) HistoryOfSubaccountTransfer(ctx context.Context, currency, subaccountType, subaccountName string, before, after time.Time, limit int64) ([]SubaccountBillItem, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, historyOfSubaccountTransferEPL, http.MethodGet, common.EncodeURLValues(assetSubaccountBills, params), nil, &resp, true)
}
...
func (ok *Okx) MasterAccountsManageTransfersBetweenSubaccounts(ctx context.Context, arg SubAccountAssetTransferParams) ([]TransferIDInfo, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, masterAccountsManageTransfersBetweenSubaccountEPL, http.MethodPost, assetSubaccountTransfer, &arg, &resp, true)
}
...
func (ok *Okx) SetPermissionOfTransferOut(ctx context.Context, arg PermissionOfTransfer) ([]PermissionOfTransfer, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, setPermissionOfTransferOutEPL, http.MethodPost, userSubaccountSetTransferOut, &arg, &resp, true)
}
...
func (ok *Okx) GetCustodyTradingSubaccountList(ctx context.Context, subaccountName string) ([]SubaccountName, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getCustodyTradingSubaccountListEPL, http.MethodGet, common.EncodeURLValues(usersEntrustSubaccountList, params), nil, &resp, true)
}
...
func (ok *Okx) PlaceGridAlgoOrder(ctx context.Context, arg *GridAlgoOrder) (*GridAlgoOrderIDResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, gridTradingEPL, http.MethodPost, gridOrderAlgo, &arg, &resp, true)
	if err != nil {
		if len(resp) != 1 {
			return nil, err
		}
...
func (ok *Okx) AmendGridAlgoOrder(ctx context.Context, arg GridAlgoOrderAmend) (*GridAlgoOrderIDResponse, error) {
	...
	var resp []GridAlgoOrderIDResponse
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, amendGridAlgoOrderEPL, http.MethodPost, gridAmendOrderAlgo, &arg, &resp, true)
	if err != nil {
		if len(resp) != 1 {
			return nil, err
		}
...
func (ok *Okx) StopGridAlgoOrder(ctx context.Context, arg []StopGridAlgoOrderRequest) ([]GridAlgoOrderIDResponse, error) {
	...
	var resp []GridAlgoOrderIDResponse
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, stopGridAlgoOrderEPL, http.MethodPost, gridAlgoOrderStop, arg, &resp, true)
	if err != nil {
		if len(resp) == 0 {
			return nil, err
		}
...
func (ok *Okx) getGridAlgoOrders(ctx context.Context, algoOrderType, algoID,
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, epl, http.MethodGet, common.EncodeURLValues(route, params), nil, &resp, true)
}
...
func (ok *Okx) GetGridAlgoOrderDetails(ctx context.Context, algoOrderType, algoID string) (*GridAlgoOrderResponse, error) {
	...
	params.Set("algoId", algoID)
	var resp []GridAlgoOrderResponse
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getGridAlgoOrderDetailsEPL, http.MethodGet, common.EncodeURLValues(gridOrdersAlgoDetails, params), nil, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetGridAlgoSubOrders(ctx context.Context, algoOrderType, algoID, subOrderType, groupID, after, before string, limit int64) ([]GridAlgoOrderResponse, error) {
	...
	var resp []GridAlgoOrderResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getGridAlgoSubOrdersEPL, http.MethodGet, common.EncodeURLValues(gridSuborders, params), nil, &resp, true)
}
...
func (ok *Okx) GetGridAlgoOrderPositions(ctx context.Context, algoOrderType, algoID string) ([]AlgoOrderPosition, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getGridAlgoOrderPositionsEPL, http.MethodGet, common.EncodeURLValues(gridPositions, params), nil, &resp, true)
}
...
func (ok *Okx) SpotGridWithdrawProfit(ctx context.Context, algoID string) (*AlgoOrderWithdrawalProfit, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, spotGridWithdrawIncomeEPL, http.MethodPost, gridWithdrawalIncome, input, &resp, true)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) ComputeMarginBalance(ctx context.Context, arg MarginBalanceParam) (*ComputeMarginBalance, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, computeMarginBalanceEPL, http.MethodPost, gridComputeMarginBalance, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) AdjustMarginBalance(ctx context.Context, arg MarginBalanceParam) (*AdjustMarginBalanceResponse, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, adjustMarginBalanceEPL, http.MethodPost, gridMarginBalance, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetGridAIParameter(ctx context.Context, algoOrderType, instrumentID, direction, duration string) ([]GridAIParameterResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getGridAIParameterEPL, http.MethodGet, common.EncodeURLValues(gridAIParams, params), nil, &resp, false)
}
...
func (ok *Okx) GetOffers(ctx context.Context, productID, protocolType, currency string) ([]Offer, error) {
	...
	var resp []Offer
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getOfferEPL, http.MethodGet, common.EncodeURLValues(financeOffers, params), nil, &resp, true)
}
...
func (ok *Okx) Purchase(ctx context.Context, arg PurchaseRequestParam) (*OrderIDResponse, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, purchaseEPL, http.MethodPost, financePurchase, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) Redeem(ctx context.Context, arg RedeemRequestParam) (*OrderIDResponse, error) {
	...
	var resp []OrderIDResponse
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, redeemEPL, http.MethodPost, financeRedeem, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) CancelPurchaseOrRedemption(ctx context.Context, arg CancelFundingParam) (*OrderIDResponse, error) {
	...
	var resp []OrderIDResponse
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, cancelPurchaseOrRedemptionEPL, http.MethodPost, financeCancelPurchase, &arg, &resp, true); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetEarnActiveOrders(ctx context.Context, productID, protocolType, currency, state string) ([]ActiveFundingOrder, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getEarnActiveOrdersEPL, http.MethodGet, common.EncodeURLValues(financeActiveOrders, params), nil, &resp, true)
}
...
func (ok *Okx) GetFundingOrderHistory(ctx context.Context, productID, protocolType, currency string, after, before time.Time, limit int64) ([]ActiveFundingOrder, error) {
	...
	var resp []ActiveFundingOrder
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getFundingOrderHistoryEPL, http.MethodGet, common.EncodeURLValues(financeOrdersHistory, params), nil, &resp, true)
}
...
func (ok *Okx) GetTickers(ctx context.Context, instType, uly, instID string) ([]TickerResponse, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getTickersEPL, http.MethodGet, common.EncodeURLValues(marketTickers, params), nil, &response, false)
}
...
func (ok *Okx) GetTicker(ctx context.Context, instrumentID string) (*TickerResponse, error) {
	...
	var response []TickerResponse
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getTickersEPL, http.MethodGet, common.EncodeURLValues(marketTicker, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
	if len(response) == 1 {
...
func (ok *Okx) GetIndexTickers(ctx context.Context, quoteCurrency, instID string) ([]IndexTicker, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getIndexTickersEPL, http.MethodGet, common.EncodeURLValues(indexTickers, params), nil, &response, false)
}

// GetInstrumentTypeFromAssetItem returns a string representation of asset.Item; which is an equivalent term for InstrumentType in Okx goex.
...
func (ok *Okx) GetOrderBookDepth(ctx context.Context, instrumentID string, depth int64) (*OrderBookResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOrderBookEPL, http.MethodGet, common.EncodeURLValues(marketBooks, params), nil, &resp, false)
	if err != nil {
		return nil, err
	} else if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetCandlestickData(ctx context.Context, instrumentID string, interval kline.Interval, before, after time.Time, limit int64, route string, rateLimit request.EndpointLimit) ([]CandleStick, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, rateLimit, http.MethodGet, common.EncodeURLValues(route, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetTrades(ctx context.Context, instrumentID string, limit int64) ([]TradeResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getTradesRequestEPL, http.MethodGet, common.EncodeURLValues(marketTrades, params), nil, &resp, false)
}
...
func (ok *Okx) GetTradesHistory(ctx context.Context, instrumentID, before, after string, limit int64) ([]TradeResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getTradesHistoryEPL, http.MethodGet, common.EncodeURLValues(marketTradesHistory, params), nil, &resp, false)
}
...
func (ok *Okx) Get24HTotalVolume(ctx context.Context) (*TradingVolumeIn24HR, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, get24HTotalVolumeEPL, http.MethodGet, marketPlatformVolumeIn24Hour, nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetOracle(ctx context.Context) (*OracleSmartContractResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOracleEPL, http.MethodGet, marketOpenOracles, nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetExchangeRate(ctx context.Context) (*UsdCnyExchangeRate, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getExchangeRateRequestEPL, http.MethodGet, marketExchangeRate, nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetIndexComponents(ctx context.Context, index string) (*IndexComponent, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getIndexComponentsEPL, http.MethodGet, common.EncodeURLValues(marketIndexComponents, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if resp == nil {
...
func (ok *Okx) GetBlockTickers(ctx context.Context, instrumentType, underlying string) ([]BlockTicker, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBlockTickersEPL, http.MethodGet, common.EncodeURLValues(marketBlockTickers, params), nil, &resp, false)
}
...
func (ok *Okx) GetBlockTicker(ctx context.Context, instrumentID string) (*BlockTicker, error) {
	...
	params.Set("instId", instrumentID)
	var resp []BlockTicker
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getBlockTickersEPL, http.MethodGet, common.EncodeURLValues(marketBlockTicker, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetBlockTrades(ctx context.Context, instrumentID string) ([]BlockTrade, error) {
	...
	params.Set("instId", instrumentID)
	var resp []BlockTrade
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getBlockTradesEPL, http.MethodGet, common.EncodeURLValues(marketBlockTrades, params), nil, &resp, false)
}
...
func (ok *Okx) GetInstruments(ctx context.Context, arg *InstrumentsFetchParams) ([]Instrument, error) {
	...
	var resp []Instrument
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getInstrumentsEPL, http.MethodGet, common.EncodeURLValues(publicInstruments, params), nil, &resp, false)
}
...
func (ok *Okx) GetDeliveryHistory(ctx context.Context, instrumentType, underlying string, after, before time.Time, limit int64) ([]DeliveryHistory, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getDeliveryExerciseHistoryEPL, http.MethodGet, common.EncodeURLValues(publicDeliveryExerciseHistory, params), nil, &resp, false)
}
...
func (ok *Okx) GetOpenInterest(ctx context.Context, instType, uly, instID string) ([]OpenInterest, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getOpenInterestEPL, http.MethodGet, common.EncodeURLValues(publicOpenInterestValues, params), nil, &resp, false)
}
...
func (ok *Okx) GetSingleFundingRate(ctx context.Context, instrumentID string) (*FundingRateResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getFundingEPL, http.MethodGet, common.EncodeURLValues(publicFundingRate, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetFundingRateHistory(ctx context.Context, instrumentID string, before, after time.Time, limit int64) ([]FundingRateResponse, error) {
	...
	var resp []FundingRateResponse
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getFundingRateHistoryEPL, http.MethodGet, common.EncodeURLValues(publicFundingRateHistory, params), nil, &resp, false)
}
...
func (ok *Okx) GetLimitPrice(ctx context.Context, instrumentID string) (*LimitPriceResponse, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getLimitPriceEPL, http.MethodGet, common.EncodeURLValues(publicLimitPath, params), nil, &resp, false); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return &resp[0], nil
...
func (ok *Okx) GetOptionMarketData(ctx context.Context, underlying string, expTime time.Time) ([]OptionMarketDataResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getOptionMarketDateEPL, http.MethodGet, common.EncodeURLValues(publicOptionalData, params), nil, &resp, false)
}
...
func (ok *Okx) GetEstimatedDeliveryPrice(ctx context.Context, instrumentID string) ([]DeliveryEstimatedPrice, error) {
	...
	params.Set("instId", instrumentID)
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getEstimatedDeliveryPriceEPL, http.MethodGet, common.EncodeURLValues(publicEstimatedPrice, params), nil, &resp, false)
}
...
func (ok *Okx) GetDiscountRateAndInterestFreeQuota(ctx context.Context, currency string, discountLevel int8) ([]DiscountRate, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getDiscountRateAndInterestFreeQuotaEPL, http.MethodGet, common.EncodeURLValues(publicDiscountRate, params), nil, &response, false)
}

// GetSystemTime Retrieve API server time.
func (ok *Okx) GetSystemTime(ctx context.Context) (time.Time, error) {
	var resp []ServerTime
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getSystemTimeEPL, http.MethodGet, publicTime, nil, &resp, false); err != nil {
		return time.Time{}, err
	}
	if len(resp) == 1 {
		return resp[0].Timestamp.Time(), nil
...
func (ok *Okx) GetLiquidationOrders(ctx context.Context, arg *LiquidationOrderRequestParams) (*LiquidationOrder, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getLiquidationOrdersEPL, http.MethodGet, common.EncodeURLValues(publicLiquidationOrders, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
	if len(response) == 1 {
...
func (ok *Okx) GetMarkPrice(ctx context.Context, instrumentType, underlying, instrumentID string) ([]MarkPrice, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getMarkPriceEPL, http.MethodGet, common.EncodeURLValues(publicMarkPrice, params), nil, &response, false)
}
...
func (ok *Okx) GetPositionTiers(ctx context.Context, instrumentType, tradeMode, underlying, instrumentID, tiers string) ([]PositionTiers, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getPositionTiersEPL, http.MethodGet, common.EncodeURLValues(publicPositionTiers, params), nil, &response, false)
}
...
func (ok *Okx) GetInterestRateAndLoanQuota(ctx context.Context) (map[string][]InterestRateLoanQuotaItem, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getInterestRateAndLoanQuotaEPL, http.MethodGet, publicInterestRateAndLoanQuota, nil, &response, false)
	if err != nil {
		return nil, err
...
func (ok *Okx) GetInterestRateAndLoanQuotaForVIPLoans(ctx context.Context) ([]VIPInterestRateAndLoanQuotaInformation, error) {
	...
	return response, ok.SendHTTPRequest(ctx, goex.RestSpot, getInterestRateAndLoanQuoteForVIPLoansEPL, http.MethodGet, publicVIPInterestRateAndLoanQuota, nil, &response, false)
}
...
func (ok *Okx) GetPublicUnderlyings(ctx context.Context, instrumentType string) ([]string, error) {
	...
	params.Set("instType", strings.ToUpper(instrumentType))
	var resp [][]string
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getUnderlyingEPL, http.MethodGet, common.EncodeURLValues(publicUnderlyings, params), nil, &resp, false); err != nil {
		return nil, err
	}
	if len(resp) == 1 {
		return resp[0], nil
...
func (ok *Okx) GetInsuranceFundInformation(ctx context.Context, arg *InsuranceFundInformationRequestParams) (*InsuranceFundInformation, error) {
	...
	if err := ok.SendHTTPRequest(ctx, goex.RestSpot, getInsuranceFundEPL, http.MethodGet, common.EncodeURLValues(publicInsuranceFunds, params), nil, &response, false); err != nil {
		return nil, err
	}
	if len(response) == 1 {
		return &response[0], nil
...
func (ok *Okx) CurrencyUnitConvert(ctx context.Context, instrumentID string, quantity, orderPrice float64, convertType uint, unitOfCurrency string) (*UnitConvertResponse, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, unitConvertEPL, http.MethodGet, common.EncodeURLValues(publicCurrencyConvertContract, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
	if len(resp) == 1 {
...
func (ok *Okx) GetSupportCoins(ctx context.Context) (*SupportedCoinsData, error) {
	...
	return &response, ok.SendHTTPRequest(ctx, goex.RestSpot, getSupportCoinEPL, http.MethodGet, tradingDataSupportedCoins, nil, &response, false)
}
...
func (ok *Okx) GetTakerVolume(ctx context.Context, currency, instrumentType string, begin, end time.Time, period kline.Interval) ([]TakerVolume, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getTakerVolumeEPL, http.MethodGet, common.EncodeURLValues(tradingTakerVolume, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetMarginLendingRatio(ctx context.Context, currency string, begin, end time.Time, period kline.Interval) ([]MarginLendRatioItem, error) {
	...
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getMarginLendingRatioEPL, http.MethodGet, common.EncodeURLValues(tradingMarginLoanRatio, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetLongShortRatio(ctx context.Context, currency string, begin, end time.Time, period kline.Interval) ([]LongShortRatio, error) {
	...
	var response [][2]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getLongShortRatioEPL, http.MethodGet, common.EncodeURLValues(longShortAccountRatio, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetContractsOpenInterestAndVolume(
	...
	var response [][3]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getContractsOpenInterestAndVolumeEPL, http.MethodGet, common.EncodeURLValues(contractOpenInterestVolume, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
	for x := range response {
...
func (ok *Okx) GetOptionsOpenInterestAndVolume(ctx context.Context, currency string,
	...
	openInterestVolumes := []OpenInterestVolume{}
	var response [][3]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOptionsOpenInterestAndVolumeEPL, http.MethodGet, common.EncodeURLValues(optionOpenInterestVolume, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
	for x := range response {
...
func (ok *Okx) GetPutCallRatio(ctx context.Context, currency string,
	...
	var response [][3]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getPutCallRatioEPL, http.MethodGet, common.EncodeURLValues(optionOpenInterestVolumeRatio, params), nil, &response, false)
	if err != nil {
		return nil, err
	}
	for x := range response {
...
func (ok *Okx) GetOpenInterestAndVolumeExpiry(ctx context.Context, currency string, period kline.Interval) ([]ExpiryOpenInterestAndVolume, error) {
	...
	var resp [][6]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOpenInterestAndVolumeEPL, http.MethodGet, common.EncodeURLValues(optionOpenInterestVolumeExpiry, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetOpenInterestAndVolumeStrike(ctx context.Context, currency string,
	...
	var resp [][6]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getOpenInterestAndVolumeEPL, http.MethodGet, common.EncodeURLValues(optionOpenInterestVolumeStrike, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) GetTakerFlow(ctx context.Context, currency string, period kline.Interval) (*CurrencyTakerFlow, error) {
	...
	var resp [7]string
	err := ok.SendHTTPRequest(ctx, goex.RestSpot, getTakerFlowEPL, http.MethodGet, common.EncodeURLValues(takerBlockVolume, params), nil, &resp, false)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) SendHTTPRequest(ctx context.Context, ep goex.URL, f request.EndpointLimit, httpMethod, requestPath string, data, result interface{}, authenticated bool) (err error) {
...
func (ok *Okx) SystemStatusResponse(ctx context.Context, state string) ([]SystemStatusResponse, error) {
	...
	return resp, ok.SendHTTPRequest(ctx, goex.RestSpot, getEventStatusEPL, http.MethodGet, common.EncodeURLValues(systemStatus, params), nil, &resp, false)
}
